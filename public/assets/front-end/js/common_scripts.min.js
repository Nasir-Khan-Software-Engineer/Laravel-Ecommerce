...
!function(t, e) {
    ...
    var e = [], E = x.document, i = Object.getPrototypeOf, a = e.slice, m = e.concat, l = e.push, o = e.indexOf, n = {}, r = n.toString, v = n.hasOwnProperty, s = v.toString, c = s.call(Object), y = {}, _ = function(t) {
    ...
    function b(t, e, n) {
        var i, o = (e = e || E).createElement("script");
    ...
    T.fn = T.prototype = {
        ...
        s !== (i = t[e]) && (c && i && (T.isPlainObject(i) || (o = Array.isArray(i))) ? (r = o ? (o = !1, 
        n && Array.isArray(n) ? n : []) : n && T.isPlainObject(n) ? n : {}, s[e] = T.extend(c, r, i)) : void 0 !== i && (s[e] = i));
        return s;
    }, T.extend({
        ...
        makeArray: function(t, e) {
            var n = e || [];
            return null != t && (d(Object(t)) ? T.merge(n, "string" == typeof t ? [ t ] : t) : l.call(n, t)), 
            n;
        },
        ...
        map: function(t, e, n) {
            var i, o, r = 0, s = [];
            if (d(t)) for (i = t.length; r < i; r++) null != (o = e(t[r], r, n)) && s.push(o); else for (r in t) null != (o = e(t[r], r, n)) && s.push(o);
            return m.apply([], s);
        },
        guid: 1,
        support: y
    ...
    var f = function(n) {
        ...
        var t, f, b, r, s, p, d, g, w, l, c, C, x, a, E, m, u, v, y, T = "sizzle" + +new Date(), _ = n.document, S = 0, i = 0, k = st(), A = st(), D = st(), I = function(t, e) {
            return t === e && (c = !0), 0;
        }, N = {}.hasOwnProperty, e = [], O = e.pop, P = e.push, L = e.push, j = e.slice, M = function(t, e) {
            for (var n = 0, i = t.length; n < i; n++) if (t[n] === e) return n;
            return -1;
        }, H = "checked|selected|async|autofocus|autoplay|controls|defer|disabled|hidden|ismap|loop|multiple|open|readonly|required|scoped", $ = "[\\x20\\t\\r\\n\\f]", z = "(?:\\\\.|[\\w-]|[^\x00-\\xa0])+", q = "\\[" + $ + "*(" + z + ")(?:" + $ + "*([*^$|!~]?=)" + $ + "*(?:'((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\"|(" + z + "))|)" + $ + "*\\]", R = ":(" + z + ")(?:\\((('((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\")|((?:\\\\.|[^\\\\()[\\]]|" + q + ")*)|.*)\\)|)", W = new RegExp($ + "+", "g"), F = new RegExp("^" + $ + "+|((?:^|[^\\\\])(?:\\\\.)*)" + $ + "+$", "g"), B = new RegExp("^" + $ + "*," + $ + "*"), U = new RegExp("^" + $ + "*([>+~]|" + $ + ")" + $ + "*"), Q = new RegExp("=" + $ + "*([^\\]'\"]*?)" + $ + "*\\]", "g"), K = new RegExp(R), V = new RegExp("^" + z + "$"), Y = {
            ID: new RegExp("^#(" + z + ")"),
            CLASS: new RegExp("^\\.(" + z + ")"),
            TAG: new RegExp("^(" + z + "|[*])"),
            ATTR: new RegExp("^" + q),
        ...
        }, X = /^(?:input|select|textarea|button)$/i, Z = /^h\d$/i, G = /^[^{]+\{\s*\[native \w/, J = /^(?:#([\w-]+)|(\w+)|\.([\w-]+))$/, tt = /[+~]/, et = new RegExp("\\\\([\\da-f]{1,6}" + $ + "?|(" + $ + ")|.)", "ig"), nt = /([\0-\x1f\x7f]|^-?\d)|^-$|[^\0-\x1f\x7f-\uFFFF\w-]/g, it = function(t, e) {
        ...
        try {
            L.apply(e = j.call(_.childNodes), _.childNodes), e[_.childNodes.length].nodeType;
        } catch (n) {
            L = {
        ...
        function rt(t, e, n, i) {
            ...
            if (!i && ((e ? e.ownerDocument || e : _) !== x && C(e), e = e || x, E)) {
                if (11 !== d && (l = J.exec(t))) if (o = l[1]) {
                    if (9 === d) {
                        if (!(s = e.getElementById(o))) return n;
                        if (s.id === o) return n.push(s), n;
                    } else if (h && (s = h.getElementById(o)) && y(e, s) && s.id === o) return n.push(s), 
                    n;
                } else {
                    if (l[2]) return L.apply(n, e.getElementsByTagName(t)), n;
                    if ((o = l[3]) && f.getElementsByClassName && e.getElementsByClassName) return L.apply(n, e.getElementsByClassName(o)), 
                    n;
                }
                if (f.qsa && !D[t + " "] && (!m || !m.test(t))) {
                    if (1 !== d) h = e, u = t; else if ("object" !== e.nodeName.toLowerCase()) {
                        for ((a = e.getAttribute("id")) ? a = a.replace(nt, it) : e.setAttribute("id", a = T), 
                        r = (c = p(t)).length; r--; ) c[r] = "#" + a + " " + vt(c[r]);
                        u = c.join(","), h = tt.test(t) && gt(e.parentNode) || e;
                    }
                    if (u) try {
                        return L.apply(n, h.querySelectorAll(u)), n;
                    } catch (t) {} finally {
        ...
        for (t in f = rt.support = {}, s = rt.isXML = function(t) {
            ...
            E = !s(x), _ !== x && (n = x.defaultView) && n.top !== n && (n.addEventListener ? n.addEventListener("unload", o, !1) : n.attachEvent && n.attachEvent("onunload", o)), 
            ...
            }), f.getElementsByClassName = G.test(x.getElementsByClassName), f.getById = lt(function(t) {
            ...
            }, u = [], m = [], (f.qsa = G.test(x.querySelectorAll)) && (lt(function(t) {
                a.appendChild(t).innerHTML = "<a id='" + T + "'></a><select id='" + T + "-\r\\' msallowcapture=''><option selected=''></option></select>", 
                t.querySelectorAll("[msallowcapture^='']").length && m.push("[*^$]=" + $ + "*(?:''|\"\")"), 
                t.querySelectorAll("[selected]").length || m.push("\\[" + $ + "*(?:value|" + H + ")"), 
                t.querySelectorAll("[id~=" + T + "-]").length || m.push("~="), t.querySelectorAll(":checked").length || m.push(":checked"), 
                t.querySelectorAll("a#" + T + "+*").length || m.push(".#.+[+~]");
            }), lt(function(t) {
                t.innerHTML = "<a href='' disabled='disabled'></a><select disabled='disabled'><option/></select>";
                var e = x.createElement("input");
                e.setAttribute("type", "hidden"), t.appendChild(e).setAttribute("name", "D"), t.querySelectorAll("[name=d]").length && m.push("name" + $ + "*[*^$|!~]?="), 
            ...
            })), (f.matchesSelector = G.test(v = a.matches || a.webkitMatchesSelector || a.mozMatchesSelector || a.oMatchesSelector || a.msMatchesSelector)) && lt(function(t) {
                f.disconnectedMatch = v.call(t, "*"), v.call(t, "[s!='']:x"), u.push("!=", R);
            }), m = m.length && new RegExp(m.join("|")), u = u.length && new RegExp(u.join("|")), 
            e = G.test(a.compareDocumentPosition), y = e || G.test(a.contains) ? function(t, e) {
                ...
                if (!o || !r) return t === x ? -1 : e === x ? 1 : o ? -1 : r ? 1 : l ? M(l, t) - M(l, e) : 0;
            ...
            if ((t.ownerDocument || t) !== x && C(t), e = e.replace(Q, "='$1']"), f.matchesSelector && E && !D[e + " "] && (!u || !u.test(e)) && (!m || !m.test(e))) try {
                var n = v.call(t, e);
            ...
            var n = b.attrHandle[e.toLowerCase()], i = n && N.call(b.attrHandle, e.toLowerCase()) ? n(t, e, !E) : void 0;
            ...
            var e, n = [], i = 0, o = 0;
            if (c = !f.detectDuplicates, l = !f.sortStable && t.slice(0), t.sort(I), c) {
            ...
            preFilter: {
                ATTR: function(t) {
                    return t[1] = t[1].replace(et, h), t[3] = (t[3] || t[4] || t[5] || "").replace(et, h), 
                ...
                PSEUDO: function(t) {
                    var e, n = !t[6] && t[2];
                    return Y.CHILD.test(t[0]) ? null : (t[3] ? t[2] = t[4] || t[5] || "" : n && K.test(n) && (e = p(n, !0)) && (e = n.indexOf(")", n.length - e) - n.length) && (t[0] = t[0].slice(0, e), 
            ...
            filter: {
                ...
                CHILD: function(p, t, e, g, m) {
                    ...
                    return 1 === g && 0 === m ? function(t) {
                        ...
                        var i, o, r, s, a, l, c = v != y ? "nextSibling" : "previousSibling", u = t.parentNode, h = _ && t.nodeName.toLowerCase(), d = !n && !_, f = !1;
                        if (u) {
                            if (v) {
                                for (;c; ) {
                                    for (s = t; s = s[c]; ) if (_ ? s.nodeName.toLowerCase() === h : 1 === s.nodeType) return !1;
                                    l = c = "only" === p && !l && "nextSibling";
                                }
                                return !0;
                            }
                            if (l = [ y ? u.firstChild : u.lastChild ], y && d) {
                                for (f = (a = (i = (o = (r = (s = u)[T] || (s[T] = {}))[s.uniqueID] || (r[s.uniqueID] = {}))[p] || [])[0] === S && i[1]) && i[2], 
                                s = a && u.childNodes[a]; s = ++a && s && s[c] || (f = a = 0) || l.pop(); ) if (1 === s.nodeType && ++f && s === t) {
                                    o[p] = [ S, a, f ];
                                    break;
                                }
                            } else if (d && (f = a = (i = (o = (r = (s = t)[T] || (s[T] = {}))[s.uniqueID] || (r[s.uniqueID] = {}))[p] || [])[0] === S && i[1]), 
                            !1 === f) for (;(s = ++a && s && s[c] || (f = a = 0) || l.pop()) && ((_ ? s.nodeName.toLowerCase() !== h : 1 !== s.nodeType) || !++f || (d && ((o = (r = s[T] || (s[T] = {}))[s.uniqueID] || (r[s.uniqueID] = {}))[p] = [ S, f ]), 
                            s !== t)); ) ;
                ...
                PSEUDO: function(t, r) {
                    var e, s = b.pseudos[t] || b.setFilters[t.toLowerCase()] || rt.error("unsupported pseudo: " + t);
                    return s[T] ? s(r) : 1 < s.length ? (e = [ t, t, "", r ], b.setFilters.hasOwnProperty(t.toLowerCase()) ? at(function(t, e) {
            ...
            pseudos: {
                ...
                lang: at(function(n) {
                    return V.test(n || "") || rt.error("unsupported lang: " + n), n = n.replace(et, h).toLowerCase(), 
                    function(t) {
                        var e;
                        do {
        ...
        function yt(a, t, e) {
            var l = t.dir, c = t.next, u = c || l, h = e && "parentNode" === u, d = i++;
            return t.first ? function(t, e, n) {
                ...
                } else for (;t = t[l]; ) if (1 === t.nodeType || h) if (o = (r = t[T] || (t[T] = {}))[t.uniqueID] || (r[t.uniqueID] = {}), 
        ...
        function wt(f, p, g, m, v, t) {
            return m && !m[T] && (m = wt(m)), v && !v[T] && (v = wt(v, t)), at(function(t, e, n, i) {
                var o, r, s, a = [], l = [], c = e.length, u = t || function(t, e, n) {
                    ...
                    return n;
                }(p || "*", n.nodeType ? [ n ] : n, []), h = !f || !t && p ? u : bt(u, a, f, n, i), d = g ? v || (t ? f : c || m) ? [] : e : h;
                if (g && g(h, d, n, i), m) for (o = bt(d, l), m(o, [], n, i), r = o.length; r--; ) (s = o[r]) && (d[l[r]] = !(h[l[r]] = s));
                if (t) {
                    if (v || f) {
                        if (v) {
                        ...
                        for (r = d.length; r--; ) (s = d[r]) && -1 < (o = v ? M(t, s) : a[r]) && (t[o] = !(e[o] = s));
                    }
                } else d = bt(d === e ? d.splice(c, d.length) : d), v ? v(null, e, d, i) : L.apply(e, d);
            });
        }
        function Ct(t) {
            for (var o, e, n, i = t.length, r = b.relative[t[0].type], s = r || b.relative[" "], a = r ? 1 : 0, l = yt(function(t) {
                ...
                return o = null, i;
            } ]; a < i; a++) if (e = b.relative[t[a].type]) u = [ yt(_t(u), e) ]; else {
                if ((e = b.filter[t[a].type].apply(null, t[a].matches))[T]) {
                    ...
                    return wt(1 < a && _t(u), 1 < a && vt(t.slice(0, a - 1).concat({
                        value: " " === t[a - 2].type ? "*" : ""
                    })).replace(F, "$1"), e, a < n && Ct(t.slice(a, n)), n < i && Ct(t = t.slice(n)), n < i && vt(t));
                }
                u.push(e);
            }
            return _t(u);
        ...
        function xt(m, v) {
            function t(t, e, n, i, o) {
                var r, s, a, l = 0, c = "0", u = t && [], h = [], d = w, f = t || _ && b.find.TAG("*", o), p = S += null == d ? 1 : Math.random() || .1, g = f.length;
                for (o && (w = e === x || e || o); c !== g && null != (r = f[c]); c++) {
                    if (_ && r) {
                        for (s = 0, e || r.ownerDocument === x || (C(r), n = !E); a = m[s++]; ) if (a(r, e || x, n)) {
                            i.push(r);
                            break;
                        }
                        o && (S = p);
                ...
                if (l += c, y && c !== l) {
                    ...
                    L.apply(i, h), o && !t && 0 < h.length && 1 < l + v.length && rt.uniqueSort(i);
                }
                return o && (S = p, w = d), u;
            }
        ...
        return mt.prototype = b.filters = b.pseudos, b.setFilters = new mt(), p = rt.tokenize = function(t, e) {
            ...
            for (s = t, a = [], l = b.preFilter; s; ) {
                ...
                n = !1, (i = U.exec(s)) && (n = i.shift(), o.push({
                    value: n,
                    type: i[0].replace(F, " ")
                }), s = s.slice(n.length)), b.filter) !(i = Y[r].exec(s)) || l[r] && !(i = l[r](i)) || (n = i.shift(), 
                o.push({
                    value: n,
                    type: r,
                    matches: i
            ...
            var n, i = [], o = [], r = D[t + " "];
            if (!r) {
                for (n = (e = e || p(t)).length; n--; ) (r = Ct(e[n]))[T] ? i.push(r) : o.push(r);
                (r = D(t, xt(o, i))).selector = t;
            }
            return r;
        }, g = rt.select = function(t, e, n, i) {
            var o, r, s, a, l, c = "function" == typeof t && t, u = !i && p(t = c.selector || t);
            if (n = n || [], 1 === u.length) {
                if (2 < (r = u[0] = u[0].slice(0)).length && "ID" === (s = r[0]).type && 9 === e.nodeType && E && b.relative[r[1].type]) {
                    if (!(e = (b.find.ID(s.matches[0].replace(et, h), e) || [])[0])) return n;
                    c && (e = e.parentNode), t = t.slice(r.shift().value.length);
                }
                for (o = Y.needsContext.test(t) ? 0 : r.length; o-- && (s = r[o], !b.relative[a = s.type]); ) if ((l = b.find[a]) && (i = l(s.matches[0].replace(et, h), tt.test(r[0].type) && gt(e.parentNode) || e))) {
                    if (r.splice(o, 1), !(t = i.length && vt(r))) return L.apply(n, i), n;
                    break;
                }
            }
            return (c || d(t, u))(i, e, !E, n, !e || tt.test(t) && gt(e.parentNode) || e), n;
        }, f.sortStable = T.split("").sort(I).join("") === T, f.detectDuplicates = !!c, 
        C(), f.sortDetached = lt(function(t) {
    ...
    (T.fn.init = function(t, e, n) {
        var i, o;
        if (!t) return this;
        if (n = n || I, "string" != typeof t) return t.nodeType ? (this[0] = t, this.length = 1, 
        ...
        if (i[1]) {
            if (e = e instanceof T ? e[0] : e, T.merge(this, T.parseHTML(i[1], e && e.nodeType ? e.ownerDocument || e : E, !0)), 
            A.test(i[1]) && T.isPlainObject(e)) for (i in e) _(this[i]) ? this[i](e[i]) : this.attr(i, e[i]);
            return this;
        }
    ...
    T.fn.extend({
        ...
        closest: function(t, e) {
            ...
            if (!S.test(t)) for (;i < o; i++) for (n = this[i]; n && n !== e; n = n.parentNode) if (n.nodeType < 11 && (s ? -1 < s.index(n) : 1 === n.nodeType && T.find.matchesSelector(n, t))) {
                r.push(n);
                break;
            }
        ...
        T.fn[i] = function(t, e) {
            ...
            return "Until" !== i.slice(-5) && (e = t), e && "string" == typeof e && (n = T.filter(e, n)), 
            1 < this.length && (P[i] || T.uniqueSort(n), O.test(i) && n.reverse()), this.pushStack(n);
        };
    });
    var j = /[^\x20\t\r\n\f]+/g;
    function M(t) {
    ...
    T.Callbacks = function(i) {
        ...
        function o() {
            for (a = a || i.once, s = r = !0; c.length; u = -1) for (e = c.shift(); ++u < l.length; ) !1 === l[u].apply(e[0], e[1]) && i.stopOnFalse && (u = l.length, 
            e = !1);
            i.memory || (e = !1), r = !1, a && (l = e ? [] : "");
        }
        var r, e, s, a, l = [], c = [], u = -1, h = {
            add: function() {
                return l && (e && !r && (u = l.length - 1, c.push(e)), function n(t) {
                    T.each(t, function(t, e) {
                        _(e) ? i.unique && h.has(e) || l.push(e) : e && e.length && "string" !== w(e) && n(e);
                    });
            ...
            fireWith: function(t, e) {
                return a || (e = [ t, (e = e || []).slice ? e.slice() : e ], c.push(e), r || o()), 
                this;
            },
            fire: function() {
        ...
        Deferred: function(t) {
            var r = [ [ "notify", "progress", T.Callbacks("memory"), T.Callbacks("memory"), 2 ], [ "resolve", "done", T.Callbacks("once memory"), T.Callbacks("once memory"), 0, "resolved" ], [ "reject", "fail", T.Callbacks("once memory"), T.Callbacks("once memory"), 1, "rejected" ] ], o = "pending", s = {
                state: function() {
                    return o;
                },
                always: function() {
                ...
                then: function(e, n, i) {
                        ...
                        return function() {
                            function t() {
                                ...
                                if (!(o < l)) {
                                    ...
                                    e = t && ("object" == typeof t || "function" == typeof t) && t.then, _(e) ? a ? e.call(t, c(l, r, M, a), c(l, r, H, a)) : (l++, 
                                    e.call(t, c(l, r, M, a), c(l, r, H, a), c(l, r, M, r.notifyWith))) : (s !== M && (n = void 0, 
                            ...
                            var n = this, i = arguments, e = a ? t : function() {
                                try {
                                    ...
                                    T.Deferred.exceptionHook && T.Deferred.exceptionHook(t, e.stackTrace), l <= o + 1 && (s !== H && (n = void 0, 
                    ...
                    return T.Deferred(function(t) {
                        r[0][3].add(c(0, t, _(i) ? i : M, t.notifyWith)), r[1][3].add(c(0, t, _(e) ? e : M)), 
                        r[2][3].add(c(0, t, _(n) ? n : H));
                    }).promise();
                },
                promise: function(t) {
    ...
    var q = T.Deferred();
    function R() {
        E.removeEventListener("DOMContentLoaded", R), x.removeEventListener("load", R), 
        T.ready();
    }
    ...
    }), T.ready.then = q.then, "complete" === E.readyState || "loading" !== E.readyState && !E.documentElement.doScroll ? x.setTimeout(T.ready) : (E.addEventListener("DOMContentLoaded", R), 
    x.addEventListener("load", R));
    var W = function(t, e, n, i, o, r, s) {
        var a = 0, l = t.length, c = null == n;
        if ("object" === w(n)) for (a in o = !0, n) W(t, e, a, n[a], !0, r, s); else if (void 0 !== i && (o = !0, 
        _(i) || (s = !0), c && (e = s ? (e.call(t, i), null) : (c = e, function(t, e, n) {
            return c.call(T(t), n);
    ...
    V.uid = 1, V.prototype = {
        ...
        set: function(t, e, n) {
            ...
            if ("string" == typeof e) o[Q(e)] = n; else for (i in e) o[Q(i)] = e[i];
            return o;
        },
        get: function(t, e) {
    ...
    function J(t, e, n) {
        var i, o;
        if (void 0 === n && 1 === t.nodeType) if (i = "data-" + e.replace(G, "-$&").toLowerCase(), 
    ...
    T.extend({
        ...
        data: function(n, t) {
            ...
            if (this.length && (o = X.get(r), 1 === r.nodeType && !Y.get(r, "hasDataAttrs"))) {
                for (e = s.length; e--; ) s[e] && 0 === (i = s[e].name).indexOf("data-") && (i = Q(i.slice(5)), 
                J(r, i, o[i]));
        ...
        queue: function(t, e, n) {
            var i;
            if (t) return e = (e || "fx") + "queue", i = Y.get(t, e), n && (!i || Array.isArray(n) ? i = Y.access(t, e, T.makeArray(n)) : i.push(n)), 
            i || [];
        },
        ...
        promise: function(t, e) {
            ...
            for ("string" != typeof t && (e = t, t = void 0), t = t || "fx"; a--; ) (i = Y.get(s[a], t + "queueHooks")) && i.empty && (o++, 
            i.empty.add(n));
    ...
    var et = /[+-]?(?:\d*\.|)\d+(?:[eE][+-]?\d+|)/.source, nt = new RegExp("^(?:([+-])=|)(" + et + ")([a-z%]*)$", "i"), it = [ "Top", "Right", "Bottom", "Left" ], ot = function(t, e) {
    ...
    function rt(t, e, n, i) {
        var o, r, s = 20, a = i ? function() {
            ...
            return T.css(t, e, "");
        }, l = a(), c = n && n[3] || (T.cssNumber[e] ? "" : "px"), u = (T.cssNumber[e] || "px" !== c && +l) && nt.exec(T.css(t, e));
        if (u && u[3] !== c) {
            for (l /= 2, c = c || u[3], u = +l || 1; s--; ) T.style(t, e, u + c), (1 - r) * (1 - (r = a() / l || .5)) <= 0 && (s = 0), 
            u /= r;
    ...
    function at(t, e) {
        ...
        e ? ("none" === n && (o[r] = Y.get(i, "display") || null, o[r] || (i.style.display = "")), 
        "" === i.style.display && ot(i) && (o[r] = (h = c = l = void 0, c = (a = i).ownerDocument, 
        u = a.nodeName, (h = st[u]) || (l = c.body.appendChild(c.createElement(u)), h = T.css(l, "display"), 
        l.parentNode.removeChild(l), "none" === h && (h = "block"), st[u] = h)))) : "none" !== n && (o[r] = "none", 
        Y.set(i, "display", n)));
        var a, l, c, u, h;
    ...
    function vt(t, e, n, i, o) {
        for (var r, s, a, l, c, u, h = e.createDocumentFragment(), d = [], f = 0, p = t.length; f < p; f++) if ((r = t[f]) || 0 === r) if ("object" === w(r)) T.merge(d, r.nodeType ? [ r ] : r); else if (mt.test(r)) {
            for (s = s || h.appendChild(e.createElement("div")), a = (ct.exec(r) || [ "", "" ])[1].toLowerCase(), 
            l = ht[a] || ht._default, s.innerHTML = l[1] + T.htmlPrefilter(r) + l[2], u = l[0]; u--; ) s = s.lastChild;
            T.merge(d, s.childNodes), (s = h.firstChild).textContent = "";
        } else d.push(e.createTextNode(r));
        for (h.textContent = "", f = 0; r = d[f++]; ) if (i && -1 < T.inArray(r, i)) o && o.push(r); else if (c = T.contains(r.ownerDocument, r), 
        s = dt(h.appendChild(r), "script"), c && ft(s), n) for (u = 0; r = s[u++]; ) ut.test(r.type || "") && n.push(r);
        return h;
    }
    pt = E.createDocumentFragment().appendChild(E.createElement("div")), (gt = E.createElement("input")).setAttribute("type", "radio"), 
    gt.setAttribute("checked", "checked"), gt.setAttribute("name", "t"), pt.appendChild(gt), 
    y.checkClone = pt.cloneNode(!0).cloneNode(!0).lastChild.checked, pt.innerHTML = "<textarea>x</textarea>", 
    y.noCloneChecked = !!pt.cloneNode(!0).lastChild.defaultValue;
    var yt = E.documentElement, _t = /^key/, bt = /^(?:mouse|pointer|contextmenu|drag|drop)|click/, wt = /^([^.]*)(?:\.(.+)|)/;
    function Ct() {
        return !0;
    }
    function xt() {
    ...
    function Tt(t, e, n, i, o, r) {
        ...
        i = void 0) : (o = i, i = n, n = void 0)), !1 === o) o = xt; else if (!o) return t;
    ...
    T.event = {
        ...
        add: function(e, t, n, i, o) {
            var r, s, a, l, c, u, h, d, f, p, g, m = Y.get(e);
            if (m) for (n.handler && (n = (r = n).handler, o = r.selector), o && T.find.matchesSelector(yt, o), 
            n.guid || (n.guid = T.guid++), (l = m.events) || (l = m.events = {}), (s = m.handle) || (s = m.handle = function(t) {
                return void 0 !== T && T.event.triggered !== t.type ? T.event.dispatch.apply(e, arguments) : void 0;
            }), c = (t = (t || "").match(j) || [ "" ]).length; c--; ) f = g = (a = wt.exec(t[c]) || [])[1], 
            p = (a[2] || "").split(".").sort(), f && (h = T.event.special[f] || {}, f = (o ? h.delegateType : h.bindType) || f, 
            h = T.event.special[f] || {}, u = T.extend({
                ...
                namespace: p.join(".")
            }, r), (d = l[f]) || ((d = l[f] = []).delegateCount = 0, h.setup && !1 !== h.setup.call(e, i, p, s) || e.addEventListener && e.addEventListener(f, s)), 
            h.add && (h.add.call(e, u), u.handler.guid || (u.handler.guid = n.guid)), o ? d.splice(d.delegateCount++, 0, u) : d.push(u), 
            T.event.global[f] = !0);
        },
        remove: function(t, e, n, i, o) {
            var r, s, a, l, c, u, h, d, f, p, g, m = Y.hasData(t) && Y.get(t);
            if (m && (l = m.events)) {
                for (c = (e = (e || "").match(j) || [ "" ]).length; c--; ) if (f = g = (a = wt.exec(e[c]) || [])[1], 
                p = (a[2] || "").split(".").sort(), f) {
        ...
        dispatch: function(t) {
            var e, n, i, o, r, s, a = T.event.fix(t), l = new Array(arguments.length), c = (Y.get(this, "events") || {})[a.type] || [], u = T.event.special[a.type] || {};
            for (l[0] = a, e = 1; e < arguments.length; e++) l[e] = arguments[e];
            if (a.delegateTarget = this, !u.preDispatch || !1 !== u.preDispatch.call(this, a)) {
                for (s = T.event.handlers.call(this, a, c), e = 0; (o = s[e++]) && !a.isPropagationStopped(); ) for (a.currentTarget = o.elem, 
                n = 0; (r = o.handlers[n++]) && !a.isImmediatePropagationStopped(); ) a.rnamespace && !a.rnamespace.test(r.namespace) || (a.handleObj = r, 
                a.data = r.data, void 0 !== (i = ((T.event.special[r.origType] || {}).handle || r.handler).apply(o.elem, l)) && !1 === (a.result = i) && (a.preventDefault(), 
                a.stopPropagation()));
        ...
        handlers: function(t, e) {
            ...
            if (l && c.nodeType && !("click" === t.type && 1 <= t.button)) for (;c !== this; c = c.parentNode || this) if (1 === c.nodeType && ("click" !== t.type || !0 !== c.disabled)) {
                for (r = [], s = {}, n = 0; n < l; n++) void 0 === s[o = (i = e[n]).selector + " "] && (s[o] = i.needsContext ? -1 < T(o, this).index(c) : T.find(o, this, null, [ c ]).length), 
                s[o] && r.push(i);
                r.length && a.push({
                    elem: c,
                    handlers: r
        ...
        t && t.type ? (this.originalEvent = t, this.type = t.type, this.isDefaultPrevented = t.defaultPrevented || void 0 === t.defaultPrevented && !1 === t.returnValue ? Ct : xt, 
        ...
        T.event.special[t] = {
            ...
            handle: function(t) {
                ...
                return n && (n === this || T.contains(this, n)) || (t.type = i.origType, e = i.handler.apply(this, arguments), 
                t.type = o), e;
            }
        };
    }), T.fn.extend({
        ...
        off: function(t, e, n) {
            ...
            this;
            if ("object" != typeof t) return !1 !== e && "function" != typeof e || (n = e, e = void 0), 
            !1 === n && (n = xt), this.each(function() {
    ...
    var St = /<(?!area|br|col|embed|hr|img|input|link|meta|param)(([a-z][^\/\0>\x20\t\r\n\f]*)[^>]*)\/>/gi, kt = /<script|<style|<link/i, At = /checked\s*(?:[^=]|=\s*.checked.)/i, Dt = /^\s*<!(?:\[CDATA\[|--)|(?:\]\]|--)>\s*$/g;
    function It(t, e) {
    ...
    function Pt(t, e) {
        var n, i, o, r, s, a, l, c;
        if (1 === e.nodeType) {
            if (Y.hasData(t) && (r = Y.access(t), s = Y.set(e, r), c = r.events)) for (o in delete s.handle, 
            s.events = {}, c) for (n = 0, i = c[o].length; n < i; n++) T.event.add(e, o, c[o][n]);
            X.hasData(t) && (a = X.access(t), l = T.extend({}, a), X.set(e, l));
        }
    }
    function Lt(n, i, o, r) {
        i = m.apply([], i);
        var t, e, s, a, l, c, u = 0, h = n.length, d = h - 1, f = i[0], p = _(f);
        if (p || 1 < h && "string" == typeof f && !y.checkClone && At.test(f)) return n.each(function(t) {
            var e = n.eq(t);
            p && (i[0] = f.call(this, t, e.html())), Lt(e, i, o, r);
        });
        if (h && (e = (t = vt(i, n[0].ownerDocument, !1, n, r)).firstChild, 1 === t.childNodes.length && (t = e), 
        e || r)) {
            for (a = (s = T.map(dt(t, "script"), Nt)).length; u < h; u++) l = t, u !== d && (l = T.clone(l, !0, !0), 
            a && T.merge(s, dt(l, "script"))), o.call(n[u], l, u);
            if (a) for (c = s[s.length - 1].ownerDocument, T.map(s, Ot), u = 0; u < a; u++) l = s[u], 
            ut.test(l.type || "") && !Y.access(l, "globalEval") && T.contains(c, l) && (l.src && "module" !== (l.type || "").toLowerCase() ? T._evalUrl && T._evalUrl(l.src) : b(l.textContent.replace(Dt, ""), c, l));
        }
        return n;
    }
    function jt(t, e, n) {
        for (var i, o = e ? T.filter(e, t) : t, r = 0; null != (i = o[r]); r++) n || 1 !== i.nodeType || T.cleanData(dt(i)), 
        i.parentNode && (n && T.contains(i.ownerDocument, i) && ft(dt(i, "script")), i.parentNode.removeChild(i));
        return t;
    }
    T.extend({
        ...
        clone: function(t, e, n) {
            var i, o, r, s, a, l, c, u = t.cloneNode(!0), h = T.contains(t.ownerDocument, t);
            if (!(y.noCloneChecked || 1 !== t.nodeType && 11 !== t.nodeType || T.isXMLDoc(t))) for (s = dt(u), 
            i = 0, o = (r = dt(t)).length; i < o; i++) a = r[i], l = s[i], "input" === (c = l.nodeName.toLowerCase()) && lt.test(a.type) ? l.checked = a.checked : "input" !== c && "textarea" !== c || (l.defaultValue = a.defaultValue);
            if (e) if (n) for (r = r || dt(t), s = s || dt(u), i = 0, o = r.length; i < o; i++) Pt(r[i], s[i]); else Pt(t, u);
        ...
        empty: function() {
            for (var t, e = 0; null != (t = this[e]); e++) 1 === t.nodeType && (T.cleanData(dt(t, !1)), 
            t.textContent = "");
            return this;
        },
        clone: function(t, e) {
        ...
        html: function(t) {
            return W(this, function(t) {
                ...
                if ("string" == typeof t && !kt.test(t) && !ht[(ct.exec(t) || [ "", "" ])[1].toLowerCase()]) {
                    t = T.htmlPrefilter(t);
                    try {
                        for (;n < i; n++) 1 === (e = this[n] || {}).nodeType && (T.cleanData(dt(e, !1)), 
                        e.innerHTML = t);
                        e = 0;
                    } catch (t) {}
                }
        ...
        T.fn[t] = function(t) {
            for (var e, n = [], i = T(t), o = i.length - 1, r = 0; r <= o; r++) e = r === o ? this : this.clone(!0), 
            T(i[r])[s](e), l.apply(n, e.get());
            return this.pushStack(n);
        };
    });
    var Mt, Ht, $t, zt, qt, Rt, Wt, Ft = new RegExp("^(" + et + ")(?!px)[a-z%]+$", "i"), Bt = function(t) {
    ...
    function Qt() {
        if (Wt) {
            ...
            Wt.style.cssText = "position:relative;display:block;box-sizing:border-box;overflow:scroll;margin:auto;border:1px;padding:1px;width:60%;top:1%", 
            yt.appendChild(Rt).appendChild(Wt);
            var t = x.getComputedStyle(Wt);
            Mt = "1%" !== t.top, qt = 12 === Kt(t.marginLeft), Wt.style.right = "60%", zt = 36 === Kt(t.right), 
            Ht = 36 === Kt(t.width), Wt.style.position = "absolute", $t = 36 === Wt.offsetWidth || "absolute", 
            yt.removeChild(Rt), Wt = null;
        }
    }
    function Kt(t) {
    ...
    function Vt(t, e, n) {
        ...
        return (n = n || Bt(t)) && ("" !== (s = n.getPropertyValue(e) || n[e]) || T.contains(t.ownerDocument, t) || (s = T.style(t, e)), 
        !y.pixelBoxStyles() && Ft.test(s) && Ut.test(e) && (i = a.width, o = a.minWidth, 
    ...
    Rt = E.createElement("div"), (Wt = E.createElement("div")).style && (Wt.style.backgroundClip = "content-box", 
    Wt.cloneNode(!0).style.backgroundClip = "", y.clearCloneStyle = "content-box" === Wt.style.backgroundClip, 
    T.extend(y, {
    ...
    var Xt = /^(none|table(?!-c[ea]).+)/, Zt = /^--/, Gt = {
        ...
        letterSpacing: "0",
        fontWeight: "400"
    }, te = [ "Webkit", "Moz", "ms" ], ee = E.createElement("div").style;
    function ne(t) {
        var e = T.cssProps[t];
    ...
    function oe(t, e, n, i, o, r) {
        ...
        for (;s < 4; s += 2) "margin" === n && (l += T.css(t, n + it[s], !0, o)), i ? ("content" === n && (l -= T.css(t, "padding" + it[s], !0, o)), 
        "margin" !== n && (l -= T.css(t, "border" + it[s] + "Width", !0, o))) : (l += T.css(t, "padding" + it[s], !0, o), 
        "padding" !== n ? l += T.css(t, "border" + it[s] + "Width", !0, o) : a += T.css(t, "border" + it[s] + "Width", !0, o));
        return !i && 0 <= r && (l += Math.max(0, Math.ceil(t["offset" + e[0].toUpperCase() + e.slice(1)] - r - l - a - .5))), 
        l;
    }
    function re(t, e, n) {
        var i = Bt(t), o = Vt(t, e, i), r = "border-box" === T.css(t, "boxSizing", !1, i), s = r;
        if (Ft.test(o)) {
            if (!n) return o;
            o = "auto";
        }
        return s = s && (y.boxSizingReliable() || o === t.style[e]), "auto" !== o && (parseFloat(o) || "inline" !== T.css(t, "display", !1, i)) || (o = t["offset" + e[0].toUpperCase() + e.slice(1)], 
        s = !0), (o = parseFloat(o) || 0) + oe(t, e, n || (r ? "border" : "content"), s, i, o) + "px";
    }
    ...
    T.extend({
        ...
        style: function(t, e, n, i) {
            if (t && 3 !== t.nodeType && 8 !== t.nodeType && t.style) {
                var o, r, s, a = Q(e), l = Zt.test(e), c = t.style;
        ...
        css: function(t, e, n, i) {
            var o, r, s, a = Q(e);
            return Zt.test(e) || (e = ne(a)), (s = T.cssHooks[e] || T.cssHooks[a]) && "get" in s && (o = s.get(t, !0, n)), 
            void 0 === o && (o = Vt(t, e, i)), "normal" === o && e in Jt && (o = Jt[e]), "" === n || n ? (r = parseFloat(o), 
            !0 === n || isFinite(r) ? r || 0 : o) : o;
        }
    }), T.each([ "height", "width" ], function(t, a) {
        T.cssHooks[a] = {
            get: function(t, e, n) {
                if (e) return !Xt.test(T.css(t, "display")) || t.getClientRects().length && t.getBoundingClientRect().width ? re(t, a, n) : tt(t, Gt, function() {
                    return re(t, a, n);
                });
            },
            set: function(t, e, n) {
                var i, o = Bt(t), r = "border-box" === T.css(t, "boxSizing", !1, o), s = n && oe(t, a, n, r, o);
                return r && y.scrollboxSize() === o.position && (s -= Math.ceil(t["offset" + a[0].toUpperCase() + a.slice(1)] - parseFloat(o[a]) - oe(t, a, "border", !1, o) - .5)), 
                s && (i = nt.exec(e)) && "px" !== (i[3] || "px") && (t.style[a] = e, e = T.css(t, a)), 
                ie(0, e, s);
            }
        };
    }), T.cssHooks.marginLeft = Yt(y.reliableMarginLeft, function(t, e) {
        ...
        init: function(t, e, n, i, o, r) {
            this.elem = t, this.prop = n, this.easing = o || T.easing._default, this.options = e, 
            this.start = this.now = this.cur(), this.end = i, this.unit = r || (T.cssNumber[n] ? "" : "px");
        },
        cur: function() {
        ...
        run: function(t) {
            ...
            n && n.set ? n.set(this) : se.propHooks._default.set(this), this;
        }
    ...
    var ae, le, ce, ue, he = /^(?:toggle|show|hide)$/, de = /queueHooks$/;
    function fe() {
        le && (!1 === E.hidden && x.requestAnimationFrame ? x.requestAnimationFrame(fe) : x.setTimeout(fe, T.fx.interval), 
        T.fx.tick());
    }
    function pe() {
    ...
    function ve(r, t, e) {
        var n, s, i = 0, o = ve.prefilters.length, a = T.Deferred().always(function() {
            delete l.elem;
        }), l = function() {
            if (s) return !1;
        ...
        for ((function(t, e) {
            var n, i, o, r, s;
            for (n in t) if (o = e[i = Q(n)], r = t[n], Array.isArray(r) && (o = r[1], r = t[n] = r[0]), 
            n !== i && (t[i] = r, delete t[n]), (s = T.cssHooks[i]) && "expand" in s) for (n in r = s.expand(r), 
            delete t[i], r) n in t || (t[n] = r[n], e[n] = o); else e[i] = o;
        }(u, c.opts.specialEasing)); i < o; i++) if (n = ve.prefilters[i].call(c, r, u, c.opts)) return _(n.stop) && (T._queueHooks(c.elem, c.opts.queue).stop = n.stop.bind(n)), 
        n;
        return T.map(u, me, c), _(c.opts.start) && c.opts.start.call(r, c), c.progress(c.opts.progress).done(c.opts.done, c.opts.complete).fail(c.opts.fail).always(c.opts.always), 
    ...
    T.Animation = T.extend(ve, {
        ...
        tweener: function(t, e) {
            for (var n, i = 0, o = (t = _(t) ? (e = t, [ "*" ]) : t.match(j)).length; i < o; i++) n = t[i], 
            ve.tweeners[n] = ve.tweeners[n] || [], ve.tweeners[n].unshift(e);
        },
        prefilters: [ function(t, e, n) {
            var i, o, r, s, a, l, c, u, h = "width" in e || "height" in e, d = this, f = {}, p = t.style, g = t.nodeType && ot(t), m = Y.get(t, "fxshow");
            ...
            null == (c = m && m.display) && (c = Y.get(t, "display")), "none" === (u = T.css(t, "display")) && (c ? u = c : (at([ t ], !0), 
            c = t.style.display || c, u = T.css(t, "display"), at([ t ]))), ("inline" === u || "inline-block" === u && null != c) && "none" === T.css(t, "float") && (l || (d.done(function() {
                p.display = c;
            ...
            n.overflow && (p.overflow = "hidden", d.always(function() {
                ...
                display: c
            }), r && (m.hidden = !g), g && at([ t ], !0), d.done(function() {
                for (i in g || at([ t ]), Y.remove(t, "fxshow"), f) T.style(t, i, f[i]);
            })), l = me(g ? m[i] : 0, i, d), i in m || (m[i] = l.start, g && (l.end = l.start, 
            l.start = 0));
        } ],
        ...
        animate: function(e, t, n, i) {
            ...
            var r = T.isEmptyObject(e), s = T.speed(t, n, i);
        ...
        stop: function(o, t, r) {
            ...
            this.each(function() {
                var t = !0, e = null != o && o + "queueHooks", n = T.timers, i = Y.get(this);
                if (e) i[e] && i[e].stop && s(i[e]); else for (e in i) i[e] && i[e].stop && de.test(e) && s(i[e]);
        ...
        finish: function(s) {
            return !1 !== s && (s = s || "fx"), this.each(function() {
                var t, e = Y.get(this), n = e[s + "queue"], i = e[s + "queueHooks"], o = T.timers, r = n ? n.length : 0;
                for (e.finish = !0, T.queue(this, s, []), i && i.stop && i.stop.call(this, !0), 
    ...
    }, ce = E.createElement("input"), ue = E.createElement("select").appendChild(E.createElement("option")), 
    ce.type = "checkbox", y.checkOn = "" !== ce.value, y.optSelected = ue.selected, 
    (ce = E.createElement("input")).value = "t", ce.type = "radio", y.radioValue = "t" === ce.value;
    var ye, _e = T.expr.attrHandle;
    T.fn.extend({
        attr: function(t, e) {
        ...
        attr: function(t, e, n) {
            ...
            if (3 !== r && 8 !== r && 2 !== r) return void 0 === t.getAttribute ? T.prop(t, e, n) : (1 === r && T.isXMLDoc(t) || (o = T.attrHooks[e.toLowerCase()] || (T.expr.match.bool.test(e) ? ye : void 0)), 
        ...
        _e[e] = function(t, e, n) {
            ...
            return n || (o = _e[r], _e[r] = i, i = null != s(t, e, n) ? r : null, _e[r] = o), 
            i;
        };
    });
    ...
    T.fn.extend({
        ...
        prop: function(t, e, n) {
            var i, o, r = t.nodeType;
            if (3 !== r && 8 !== r && 2 !== r) return 1 === r && T.isXMLDoc(t) || (e = T.propFix[e] || e, 
            o = T.propHooks[e]), void 0 !== n ? o && "set" in o && void 0 !== (i = o.set(t, n, e)) ? i : t[e] = n : o && "get" in o && null !== (i = o.get(t, e)) ? i : t[e];
        },
        propHooks: {
            tabIndex: {
                get: function(t) {
        ...
        addClass: function(e) {
            ...
            if ((t = Ee(e)).length) for (;n = this[l++]; ) if (o = xe(n), i = 1 === n.nodeType && " " + Ce(o) + " ") {
        ...
        toggleClass: function(o, e) {
            ...
            return "boolean" == typeof e && s ? e ? this.addClass(o) : this.removeClass(o) : _(o) ? this.each(function(t) {
                ...
                var t, e, n, i;
                if (s) for (e = 0, n = T(this), i = Ee(o); t = i[e++]; ) n.hasClass(t) ? n.removeClass(t) : n.addClass(t); else void 0 !== o && "boolean" != r || ((t = xe(this)) && Y.set(this, "__className__", t), 
                this.setAttribute && this.setAttribute("class", t || !1 === o ? "" : Y.get(this, "__className__") || ""));
            });
        },
        hasClass: function(t) {
            var e, n, i = 0;
            for (e = " " + t + " "; n = this[i++]; ) if (1 === n.nodeType && -1 < (" " + Ce(xe(n)) + " ").indexOf(e)) return !0;
            return !1;
        }
    });
    var Te = /\r/g;
    T.fn.extend({
        val: function(n) {
            ...
            })) : e ? (i = T.valHooks[e.type] || T.valHooks[e.nodeName.toLowerCase()]) && "get" in i && void 0 !== (t = i.get(e, "value")) ? t : "string" == typeof (t = e.value) ? t.replace(Te, "") : null == t ? "" : t : void 0;
        }
    }), T.extend({
        valHooks: {
            option: {
    ...
    T.extend(T.event, {
        trigger: function(t, e, n, i) {
            var o, r, s, a, l, c, u, h, d = [ n || E ], f = v.call(t, "type") ? t.type : t, p = v.call(t, "namespace") ? t.namespace.split(".") : [];
            if (r = h = s = n = n || E, 3 !== n.nodeType && 8 !== n.nodeType && !ke.test(f + T.event.triggered) && (-1 < f.indexOf(".") && (f = (p = f.split(".")).shift(), 
            p.sort()), l = f.indexOf(":") < 0 && "on" + f, (t = t[T.expando] ? t : new T.Event(f, "object" == typeof t && t)).isTrigger = i ? 2 : 3, 
            t.namespace = p.join("."), t.rnamespace = t.namespace ? new RegExp("(^|\\.)" + p.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, 
            t.result = void 0, t.target || (t.target = n), e = null == e ? [ t ] : T.makeArray(e, [ t ]), 
            u = T.event.special[f] || {}, i || !u.trigger || !1 !== u.trigger.apply(n, e))) {
                if (!i && !u.noBubble && !g(n)) {
                    for (a = u.delegateType || f, ke.test(a + f) || (r = r.parentNode); r; r = r.parentNode) d.push(r), 
                    s = r;
                    s === (n.ownerDocument || E) && d.push(s.defaultView || s.parentWindow || x);
                }
                for (o = 0; (r = d[o++]) && !t.isPropagationStopped(); ) h = r, t.type = 1 < o ? a : u.bindType || f, 
                (c = (Y.get(r, "events") || {})[t.type] && Y.get(r, "handle")) && c.apply(r, e), 
                (c = l && r[l]) && c.apply && K(r) && (t.result = c.apply(r, e), !1 === t.result && t.preventDefault());
                return t.type = f, i || t.isDefaultPrevented() || u._default && !1 !== u._default.apply(d.pop(), e) || !K(n) || l && _(n[f]) && !g(n) && ((s = n[l]) && (n[l] = null), 
                T.event.triggered = f, t.isPropagationStopped() && h.addEventListener(f, Se), n[f](), 
                t.isPropagationStopped() && h.removeEventListener(f, Se), T.event.triggered = void 0, 
                s && (n[l] = s)), t.result;
            }
        },
        ...
        T.event.special[i] = {
            setup: function() {
                var t = this.ownerDocument || this, e = Y.access(t, i);
                e || t.addEventListener(n, o, !0), Y.access(t, i, (e || 0) + 1);
            },
            teardown: function() {
                var t = this.ownerDocument || this, e = Y.access(t, i) - 1;
                e ? Y.access(t, i, e) : (t.removeEventListener(n, o, !0), Y.remove(t, i));
            }
        };
    });
    var Ae = x.location, De = Date.now(), Ie = /\?/;
    ...
    function je(n, t, i, o) {
        ...
        if (Array.isArray(t)) T.each(t, function(t, e) {
            i || Ne.test(n) ? o(n, e) : je(n + "[" + ("object" == typeof e && null != e ? t : "") + "]", e, i, o);
        }); else if (i || "object" !== w(t)) o(n, t); else for (e in t) je(n + "[" + e + "]", t[e], i, o);
    }
    T.param = function(t, e) {
        ...
        serializeArray: function() {
            return this.map(function() {
                ...
                var t = this.type;
                return this.name && !T(this).is(":disabled") && Le.test(this.nodeName) && !Pe.test(t) && (this.checked || !lt.test(t));
            }).map(function(t, e) {
                var n = T(this).val();
    ...
    var Me = /%20/g, He = /#.*$/, $e = /([?&])_=[^&]*/, ze = /^(.*?):[ \t]*([^\r\n]*)$/gm, qe = /^(?:GET|HEAD)$/, Re = /^\/\//, We = {}, Fe = {}, Be = "*/".concat("*"), Ue = E.createElement("a");
    function Qe(r) {
        return function(t, e) {
    ...
    Ue.href = Ae.href, T.extend({
        ...
        ajax: function(t, e) {
            ...
            var u, h, d, n, f, i, p, g, o, r, m = T.ajaxSetup({}, e), v = m.context || m, y = m.context && (v.nodeType || v.jquery) ? T(v) : T.event, _ = T.Deferred(), b = T.Callbacks("once memory"), w = m.statusCode || {}, s = {}, a = {}, l = "canceled", C = {
                readyState: 0,
                getResponseHeader: function(t) {
                    var e;
                    if (p) {
                        if (!n) for (n = {}; e = ze.exec(d); ) n[e[1].toLowerCase()] = e[2];
                        e = n[t.toLowerCase()];
                    }
                ...
                statusCode: function(t) {
                    var e;
                    if (t) if (p) C.always(t[C.status]); else for (e in t) w[e] = [ w[e], t[e] ];
                    return this;
                },
                abort: function(t) {
                    var e = t || l;
            ...
            if (_.promise(C), m.url = ((t || m.url || Ae.href) + "").replace(Re, Ae.protocol + "//"), 
            m.type = e.method || e.type || m.method || m.type, m.dataTypes = (m.dataType || "*").toLowerCase().match(j) || [ "" ], 
            null == m.crossDomain) {
                i = E.createElement("a");
                try {
            ...
            Ke(We, m, e, C), p) return C;
            for (o in (g = T.event && m.global) && 0 == T.active++ && T.event.trigger("ajaxStart"), 
            m.type = m.type.toUpperCase(), m.hasContent = !qe.test(m.type), h = m.url.replace(He, ""), 
            m.hasContent ? m.data && m.processData && 0 === (m.contentType || "").indexOf("application/x-www-form-urlencoded") && (m.data = m.data.replace(Me, "+")) : (r = m.url.slice(h.length), 
            m.data && (m.processData || "string" == typeof m.data) && (h += (Ie.test(h) ? "&" : "?") + m.data, 
            delete m.data), !1 === m.cache && (h = h.replace($e, "$1"), r = (Ie.test(h) ? "&" : "?") + "_=" + De++ + r), 
            m.url = h + r), m.ifModified && (T.lastModified[h] && C.setRequestHeader("If-Modified-Since", T.lastModified[h]), 
            T.etag[h] && C.setRequestHeader("If-None-Match", T.etag[h])), (m.data && m.hasContent && !1 !== m.contentType || e.contentType) && C.setRequestHeader("Content-Type", m.contentType), 
            C.setRequestHeader("Accept", m.dataTypes[0] && m.accepts[m.dataTypes[0]] ? m.accepts[m.dataTypes[0]] + ("*" !== m.dataTypes[0] ? ", " + Be + "; q=0.01" : "") : m.accepts["*"]), 
            m.headers) C.setRequestHeader(o, m.headers[o]);
            if (m.beforeSend && (!1 === m.beforeSend.call(v, C, m) || p)) return C.abort();
            if (l = "abort", b.add(m.complete), C.done(m.success), C.fail(m.error), u = Ke(Fe, m, e, C)) {
            ...
            function c(t, e, n, i) {
                var o, r, s, a, l, c = e;
                p || (p = !0, f && x.clearTimeout(f), u = void 0, d = i || "", C.readyState = 0 < t ? 4 : 0, 
                ...
                }(m, a, C, o), o ? (m.ifModified && ((l = C.getResponseHeader("Last-Modified")) && (T.lastModified[h] = l), 
                (l = C.getResponseHeader("etag")) && (T.etag[h] = l)), 204 === t || "HEAD" === m.type ? c = "nocontent" : 304 === t ? c = "notmodified" : (c = a.state, 
                r = a.data, o = !(s = a.error))) : (s = c, !t && c || (c = "error", t < 0 && (t = 0))), 
                C.status = t, C.statusText = (e || c) + "", o ? _.resolveWith(v, [ r, c, C ]) : _.rejectWith(v, [ C, c, s ]), 
                C.statusCode(w), w = void 0, g && y.trigger(o ? "ajaxSuccess" : "ajaxError", [ C, m, o ? r : s ]), 
                b.fireWith(v, [ C, c ]), g && (y.trigger("ajaxComplete", [ C, m ]), --T.active || T.event.trigger("ajaxStop")));
            }
            return C;
        },
    ...
    y.cors = !!Xe && "withCredentials" in Xe, y.ajax = Xe = !!Xe, T.ajaxTransport(function(o) {
        var r, s;
        if (y.cors || Xe && !o.crossDomain) return {
            send: function(t, e) {
                var n, i = o.xhr();
                ...
                r = function(t) {
                    return function() {
                        ...
                        "abort" === t ? i.abort() : "error" === t ? "number" != typeof i.status ? e(0, "error") : e(i.status, i.statusText) : e(Ye[i.status] || i.status, i.statusText, "text" !== (i.responseType || "text") || "string" != typeof i.responseText ? {
                            binary: i.response
                        } : {
                            text: i.responseText
    ...
    T.ajaxSetup({
        ...
        jsonpCallback: function() {
            var t = Ge.pop() || T.expando + "_" + De++;
            return this[t] = !0, t;
        }
    }), T.ajaxPrefilter("json jsonp", function(t, e, n) {
        var i, o, r, s = !1 !== t.jsonp && (Je.test(t.url) ? "url" : "string" == typeof t.data && 0 === (t.contentType || "").indexOf("application/x-www-form-urlencoded") && Je.test(t.data) && "data");
        if (s || "jsonp" === t.dataTypes[0]) return i = t.jsonpCallback = _(t.jsonpCallback) ? t.jsonpCallback() : t.jsonpCallback, 
        s ? t[s] = t[s].replace(Je, "$1" + i) : !1 !== t.jsonp && (t.url += (Ie.test(t.url) ? "&" : "?") + t.jsonp + "=" + i), 
        t.converters["script json"] = function() {
            return r || T.error(i + " was not called"), r[0];
        }, t.dataTypes[0] = "json", o = x[i], x[i] = function() {
            r = arguments;
        }, n.always(function() {
            void 0 === o ? T(x).removeProp(i) : x[i] = o, t[i] && (t.jsonpCallback = e.jsonpCallback, 
            Ge.push(i)), r && _(o) && o(r[0]), r = o = void 0;
        }), "script";
    }), y.createHTMLDocument = ((Ze = E.implementation.createHTMLDocument("").body).innerHTML = "<form></form><form></form>", 
    2 === Ze.childNodes.length), T.parseHTML = function(t, e, n) {
        return "string" != typeof t ? [] : ("boolean" == typeof e && (n = e, e = !1), e || (y.createHTMLDocument ? ((i = (e = E.implementation.createHTMLDocument("")).createElement("base")).href = E.location.href, 
        e.head.appendChild(i)) : e = E), r = !n && [], (o = A.exec(t)) ? [ e.createElement(o[1]) ] : (o = vt([ t ], e, r), 
        r && r.length && T(r).remove(), T.merge([], o.childNodes)));
        var i, o, r;
    }, T.fn.load = function(t, e, n) {
        var i, o, r, s = this, a = t.indexOf(" ");
        return -1 < a && (i = Ce(t.slice(a)), t = t.slice(0, a)), _(e) ? (n = e, e = void 0) : e && "object" == typeof e && (o = "POST"), 
        0 < s.length && T.ajax({
            url: t,
            type: o || "GET",
            dataType: "html",
        ...
        setOffset: function(t, e, n) {
            ...
            "static" === c && (t.style.position = "relative"), a = u.offset(), r = T.css(t, "top"), 
            l = T.css(t, "left"), o = ("absolute" === c || "fixed" === c) && -1 < (r + l).indexOf("auto") ? (s = (i = u.position()).top, 
            i.left) : (s = parseFloat(r) || 0, parseFloat(l) || 0), _(e) && (e = e.call(t, n, T.extend({}, a))), 
        ...
        T.cssHooks[n] = Yt(y.pixelPosition, function(t, e) {
            if (e) return e = Vt(t, n), Ft.test(e) ? T(t).position()[n] + "px" : e;
        });
    }), T.each({
        Height: "height",
        Width: "width"
        ...
        var n, i, o;
        if ("string" == typeof e && (n = t[e], e = t, t = n), _(t)) return i = a.call(arguments, 2), 
        (o = function() {
            return t.apply(e || this, i.concat(a.call(arguments)));
        }).guid = t.guid = t.guid || T.guid++, o;
    }, T.holdReady = function(t) {
        t ? T.readyWait++ : T.ready(!0);
    }, T.isArray = Array.isArray, T.parseJSON = JSON.parse, T.nodeName = k, T.isFunction = _, 
    T.isWindow = g, T.camelCase = Q, T.type = w, T.now = Date.now, T.isNumeric = function(t) {
        var e = T.type(t);
        return ("number" === e || "string" === e) && !isNaN(t - parseFloat(t));
    }, "function" == typeof define && define.amd && define("jquery", [], function() {
        return T;
    });
    var tn = x.jQuery, en = x.$;
    return T.noConflict = function(t) {
        return x.$ === T && (x.$ = en), t && x.jQuery === T && (x.jQuery = tn), T;
    }, t || (x.jQuery = x.$ = T), T;
}), function(l, n, o, a) {
    function c(t, e) {
    ...
    c.Defaults = {
        ...
        filter: [ "width", "items", "settings" ],
        run: function(t) {
            var e = this.settings.margin || "", n = !this.settings.autoWidth, i = this.settings.rtl, o = {
                width: "auto",
                "margin-left": i ? e : "",
                "margin-right": i ? "" : e
            };
        ...
        filter: [ "width", "items", "settings" ],
        run: function(t) {
            var e = (this.width() / this.settings.items).toFixed(3) - this.settings.margin, n = null, i = this._items.length, o = !this.settings.autoWidth, r = [];
            for (t.items = {
                merge: !1,
                width: e
            }; i--; ) n = this._mergers[i], n = this.settings.mergeFit && Math.min(n, this.settings.items) || n, 
            t.items.merge = 1 < n || t.items.merge, r[i] = o ? e * n : this._items[i].width();
            this._widths = r;
        }
    }, {
        filter: [ "items", "settings" ],
        run: function() {
            var t = [], e = this._items, n = this.settings, i = Math.max(2 * n.items, 4), o = 2 * Math.ceil(e.length / 2), r = n.loop && e.length ? n.rewind ? i : Math.max(i, o) : 0, s = "", a = "";
            for (r /= 2; 0 < r; ) t.push(this.normalize(t.length / 2, !0)), s += e[t[t.length - 1]][0].outerHTML, 
        ...
        filter: [ "width", "items", "settings" ],
        run: function() {
            for (var t = this.settings.rtl ? 1 : -1, e = this._clones.length + this._items.length, n = -1, i = 0, o = 0, r = []; ++n < e; ) i = r[n - 1] || 0, 
            o = this._widths[this.relative(n)] + this.settings.margin, r.push(i + o * t);
            this._coordinates = r;
        }
    }, {
        filter: [ "width", "items", "settings" ],
        ...
        delete i.responsive, i.responsiveClass && this.$element.attr("class", this.$element.attr("class").replace(new RegExp("(" + this.options.responsiveClass + "-)\\S+\\s", "g"), "$1" + n))) : i = l.extend({}, this.options), 
        this.trigger("change", {
            property: {
                name: "settings",
                value: i
        ...
        l(o).on("mouseup.owl.core touchend.owl.core", l.proxy(this.onDragEnd, this)), l(o).one("mousemove.owl.core touchmove.owl.core", l.proxy(function(t) {
        ...
        var e = null, n = null, i = null, o = this.difference(this._drag.pointer, this.pointer(t)), r = this.difference(this._drag.stage.start, o);
        this.is("dragging") && (t.preventDefault(), this.settings.loop ? (e = this.coordinates(this.minimum()), 
        n = this.coordinates(this.maximum() + 1) - e, r.x = ((r.x - e) % n + n) % n + e) : (e = this.settings.rtl ? this.coordinates(this.maximum()) : this.coordinates(this.minimum()), 
        n = this.settings.rtl ? this.coordinates(this.minimum()) : this.coordinates(this.maximum()), 
        i = this.settings.pullDrag ? -1 * o.x / 5 : 0, r.x = Math.max(Math.min(r.x, e + i), n + i)), 
        this._drag.stage.current = r, this.animate(r.x));
    }, c.prototype.onDragEnd = function(t) {
        var e = this.difference(this._drag.pointer, this.pointer(t)), n = this._drag.stage.current, i = 0 < e.x ^ this.settings.rtl ? "left" : "right";
        l(o).off(".owl.core"), this.$element.removeClass(this.options.grabClass), (0 !== e.x && this.is("dragging") || !this.is("valid")) && (this.speed(this.settings.dragEndSpeed || this.settings.smartSpeed), 
        this.current(this.closest(n.x, 0 !== e.x ? i : this._drag.direction)), this.invalidate("position"), 
        this.update(), this._drag.direction = i, (3 < Math.abs(e.x) || 300 < new Date().getTime() - this._drag.time) && this._drag.target.one("click.owl.core", function() {
            return !1;
        ...
        return this.settings.freeDrag || l.each(s, l.proxy(function(t, e) {
            return "left" === i && e - 30 < n && n < e + 30 ? o = t : "right" === i && e - r - 30 < n && n < e - r + 30 ? o = t + 1 : this.op(n, "<", e) && this.op(n, ">", s[t + 1] !== a ? s[t + 1] : e - r) && (o = "left" === i ? t + 1 : t), 
            -1 === o;
        }, this)), this.settings.loop || (this.op(n, ">", s[this.minimum()]) ? o = n = this.minimum() : this.op(n, "<", s[this.maximum()]) && (o = n = this.maximum())), 
        o;
        ...
        return !this.isNumeric(t) || n < 1 ? t = a : (t < 0 || n + i <= t) && (t = ((t - i / 2) % n + n) % n + i / 2), 
        t;
        ...
        }, this)) : (this.settings.center ? (this.settings.rtl && (n = -1, i = t + 1), e = this._coordinates[t], 
        e += (this.width() - e + (this._coordinates[i] || 0)) / 2 * n) : e = this._coordinates[i] || 0, 
        e = Math.ceil(e));
    }, c.prototype.duration = function(t, e, n) {
        return 0 === n ? 0 : Math.min(Math.max(Math.abs(e - t), 1), 6) * Math.abs(n || this.settings.smartSpeed);
    }, c.prototype.to = function(t, e) {
        var n = this.current(), i = null, o = t - this.relative(n), r = (0 < o) - (o < 0), s = this._items.length, a = this.minimum(), l = this.maximum();
        this.settings.loop ? (!this.settings.rewind && Math.abs(o) > s / 2 && (o += -1 * r * s), 
        (i = (((t = n + o) - a) % s + s) % s + a) !== t && i - o <= l && 0 < i - o && (n = i - o, 
        ...
        e = e === a ? this._items.length : this.normalize(e, !0), t = t instanceof jQuery ? t : l(t), 
        this.trigger("add", {
            content: t,
            position: e
        }), t = this.prepare(t), 0 === this._items.length || e === this._items.length ? (0 === this._items.length && this.$stage.append(t), 
        0 !== this._items.length && this._items[e - 1].after(t), this._items.push(t), this._mergers.push(+t.find("[data-merge]").addBack("[data-merge]").attr("data-merge") || 1)) : (this._items[e].before(t), 
        this._items.splice(e, 0, t), this._mergers.splice(e, 0, +t.find("[data-merge]").addBack("[data-merge]").attr("data-merge") || 1)), 
        ...
        for (var t in this.$element.off(".owl.core"), this.$stage.off(".owl.core"), l(o).off(".owl.core"), 
        ...
        var r = {
            ...
            return t;
        }).join("-").toLowerCase()), a = l.Event([ t, "owl", n || "carousel" ].join(".").toLowerCase(), l.extend({
            relatedTarget: this
        }, r, e));
        ...
        } else n.type === c.Type.State && (this._states.tags[n.name] ? this._states.tags[n.name] = this._states.tags[n.name].concat(n.tags) : this._states.tags[n.name] = n.tags, 
        ...
        return this.each(function() {
            ...
            n || (n = new c(this, "object" == typeof e && e), t.data("owl.carousel", n), l.each([ "next", "prev", "to", "destroy", "refresh", "replace", "add", "remove" ], function(t, e) {
                n.register({
                    ...
                    t.namespace && t.relatedTarget !== this && (this.suppress([ e ]), n[e].apply(this, [].slice.call(arguments, 1)), 
                    this.release([ e ]));
                }, n));
        ...
        this._core = t, this._loaded = [], this._handlers = {
            "initialized.owl.carousel change.owl.carousel resized.owl.carousel": a.proxy(function(t) {
                if (t.namespace && this._core.settings && this._core.settings.lazyLoad && (t.property && "position" == t.property.name || "initialized" == t.type)) {
                    var e = this._core.settings, n = e.center && Math.ceil(e.items / 2) || e.items, i = e.center && -1 * n || 0, o = (t.property && void 0 !== t.property.value ? t.property.value : this._core.current()) + i, r = this._core.clones().length, s = a.proxy(function(t, e) {
                        this.load(e);
                    }, this);
                    for (0 < e.lazyLoadEager && (n += e.lazyLoadEager, e.loop && (o -= e.lazyLoadEager, 
                    n++)); i++ < n; ) this.load(r / 2 + this._core.relative(o)), r && a.each(this._core.clones(this._core.relative(o)), s), 
                    o++;
                }
            }, this)
    ...
    e.Defaults = {
        ...
        !n || -1 < a.inArray(e.get(0), this._loaded) || (n.each(a.proxy(function(t, e) {
            var n, i = a(e), o = 1 < r.devicePixelRatio && i.attr("data-src-retina") || i.attr("data-src") || i.attr("data-srcset");
    ...
    i.Defaults = {
        ...
        var t = this._core._current, e = t + this._core.settings.items, n = this._core.settings.lazyLoad, i = this._core.$stage.children().toArray().slice(t, e), o = [], r = 0;
    ...
    var e = function(t) {
        this.core = t, this.core.options = s.extend({}, e.Defaults, this.core.options), 
    ...
    e.Defaults = {
        ...
        if (1 === this.core.settings.items && s.support.animation && s.support.transition) {
            ...
            n.one(s.support.animation.end, e).css({
                left: t + "px"
    ...
    n.Defaults = {
        ...
        var n;
        this._core.is("rotating") || this._core.enter("rotating"), t = t || this._core.settings.autoplayTimeout, 
        n = Math.min(this._time % (this._timeout || t), t), this._paused ? (this._time = this.read(), 
        this._paused = !1) : o.clearTimeout(this._call), this._time += this.read() % t - n, 
        this._timeout = t, this._call = o.setTimeout(i.proxy(this._next, this, e), t - n);
    }, n.prototype.stop = function() {
        this._core.is("rotating") && (this._time = 0, this._paused = !0, o.clearTimeout(this._call), 
    ...
    e.Defaults = {
        ...
        for (t in this._controls.$relative = (n.navContainer ? r(n.navContainer) : r("<div>").addClass(n.navContainerClass).appendTo(this.$element)).addClass("disabled"), 
        this._controls.$previous = r("<" + n.navElement + ">").addClass(n.navClass[0]).html(n.navText[0]).prependTo(this._controls.$relative).on("click", r.proxy(function(t) {
        ...
        }, this)), n.dotsData || (this._templates = [ r('<button role="button">').addClass(n.dotClass).append(r("<span>")).prop("outerHTML") ]), 
        this._controls.$absolute = (n.dotsContainer ? r(n.dotsContainer) : r("<div>").addClass(n.dotsClass).appendTo(this.$element)).addClass("disabled"), 
        this._controls.$absolute.on("click", "button", r.proxy(function(t) {
        ...
        var t, e, n = this._core.clones().length / 2, i = n + this._core.items().length, o = this._core.maximum(!0), r = this._core.settings, s = r.center || r.autoWidth || r.dotsData ? 1 : r.dotsEach || r.items;
        ...
        this._controls.$relative.toggleClass("disabled", !e.nav || n), e.nav && (this._controls.$previous.toggleClass("disabled", !o && i <= this._core.minimum(!0)), 
        this._controls.$next.toggleClass("disabled", !o && i >= this._core.maximum(!0))), 
        this._controls.$absolute.toggleClass("disabled", !e.dots || n), e.dots && (t = this._pages.length - this._controls.$absolute.children().length, 
        ...
        this._controls.$absolute.find(".active").removeClass("active"), this._controls.$absolute.children().eq(r.inArray(this.current(), this._pages)).addClass("active"));
    ...
    var e = function(t) {
        this._core = t, this._hashes = {}, this.$element = this._core.$element, this._handlers = {
            ...
            "changed.owl.carousel": i.proxy(function(t) {
                if (t.namespace && "position" === t.property.name) {
                    var n = this._core.items(this._core.relative(this._core.current())), e = i.map(this._hashes, function(t, e) {
                        return t === n ? e : null;
                    }).join();
        ...
        }, this._core.options = i.extend({}, e.Defaults, this._core.options), this.$element.on(this._handlers), 
        i(o).on("hashchange.owl.navigation", i.proxy(function(t) {
            var e = o.location.hash.substring(1), n = this._core.$stage.children(), i = this._hashes[e] && n.index(this._hashes[e]);
    ...
    var s = o("<support>").get(0).style, a = "Webkit Moz O ms".split(" "), t = {
        transition: {
            end: {
    ...
    i() && (o.support.animation = new String(c("animation")), o.support.animation.end = t.animation.end[o.support.animation]), 
    e() && (o.support.transform = new String(c("transform")), o.support.transform3d = n());
}(window.Zepto || window.jQuery, (window, void document)), function(t, e) {
    ...
    var e, n, i, o, p, g, m, v, s, a, l, c, u, r, h, d, f, y, _, b, w, C, x, E, T, S, k, A, D, I, N, O, P, L, j, M, H, $, z, q, R, W, F;
    (H = t)[F = "mmenu"] && "6.1.8" < H[F].version || (H[F] = function(t, e, n) {
        return this.$menu = t, this._api = [ "bind", "getInstance", "initPanels", "openPanel", "closePanel", "closeAllPanels", "setSelected" ], 
        this.opts = e, this.conf = n, this.vars = {}, this.cbck = {}, this.mtch = {}, "function" == typeof this.___deprecated && this.___deprecated(), 
        ...
        this;
    }, H[F].version = "6.1.8", H[F].addons = {}, H[F].uniqueId = 0, H[F].defaults = {
        extensions: [],
        initMenu: function() {},
        initPanels: function() {},
        navbar: {
        ...
        openPanel: function(t, e) {
            if (this.trigger("openPanel:before", t), t && t.length && (t.is("." + $.panel) || (t = t.closest("." + $.panel)), 
            t.is("." + $.panel))) {
                var n = this;
                if ("boolean" != typeof e && (e = !0), t.hasClass($.vertical)) t.add(t.parents("." + $.vertical)).removeClass($.hidden).parent("li").addClass($.opened), 
                this.openPanel(t.parents("." + $.panel).not("." + $.vertical).first()), this.trigger("openPanel:start", t), 
                this.trigger("openPanel:finish", t); else {
                    if (t.hasClass($.opened)) return;
                    var i = this.$pnls.children("." + $.panel), o = i.filter("." + $.opened);
                    if (!H[F].support.csstransitions) return o.addClass($.hidden).removeClass($.opened), 
                    t.removeClass($.hidden).addClass($.opened), this.trigger("openPanel:start", t), 
                    void this.trigger("openPanel:finish", t);
                    i.not(t).removeClass($.subopened);
                    for (var r = t.data(z.parent); r; ) (r = r.closest("." + $.panel)).is("." + $.vertical) || r.addClass($.subopened), 
                    r = r.data(z.parent);
                    i.removeClass($.highest).not(o).not(t).addClass($.hidden), t.removeClass($.hidden), 
                    this.openPanelStart = function() {
                        o.removeClass($.opened), t.addClass($.opened), t.hasClass($.subopened) ? (o.addClass($.highest), 
                        t.removeClass($.subopened)) : (o.addClass($.subopened), t.addClass($.highest)), 
        ...
        closePanel: function(t) {
            ...
            var e = t.parent();
            e.hasClass($.vertical) && (e.removeClass($.opened), this.trigger("closePanel", t)), 
        ...
        closeAllPanels: function(t) {
            ...
            var e = this.$pnls.children("." + $.panel), n = t && t.length ? t : e.first();
            this.$pnls.children("." + $.panel).not(n).removeClass($.subopened).removeClass($.opened).removeClass($.highest).addClass($.hidden), 
        ...
        setSelected: function(t) {
            this.trigger("setSelected:before", t), this.$menu.find("." + $.listview).children("." + $.selected).removeClass($.selected), 
            t.addClass($.selected), this.trigger("setSelected:after", t);
        },
        bind: function(t, e) {
        ...
        _initAddons: function() {
            var t;
            for (t in this.trigger("initAddons:before"), H[F].addons) H[F].addons[t].add.call(this), 
        ...
        _initExtensions: function() {
            ...
            }), this.opts.extensions) this.opts.extensions[t] = this.opts.extensions[t].length ? "mm-" + this.opts.extensions[t].join(" mm-") : "", 
        ...
        _initMenu: function() {
            ...
            this.$pnls = H('<div class="' + $.panels + '" />').append(this.$menu.children(this.conf.panelNodetype)).prependTo(this.$menu);
            var t = [ $.menu ];
            this.opts.slidingSubmenus || t.push($.vertical), this.$menu.addClass(t.join(" ")).parent().addClass($.wrapper), 
            this.trigger("initMenu:after");
        },
        _initPanels: function(t) {
            this.trigger("initPanels:before", t), t = t || this.$pnls.children(this.conf.panelNodetype);
            var n = H(), i = this, o = function(t) {
                t.filter(this.conf.panelNodetype).each(function() {
                    var t = i._initPanel(H(this));
                    if (t) {
                        i._initNavbar(t), i._initListview(t), n = n.add(t);
                        var e = t.children("." + $.listview).children("li").children(i.conf.panelNodeType).add(t.children("." + i.conf.classNames.panel));
                        e.length && o.call(i, e);
                    }
                });
            };
        ...
        _initPanel: function(t) {
            ...
            if (this.__refactorClass(t, this.conf.classNames.panel, "panel"), this.__refactorClass(t, this.conf.classNames.nopanel, "nopanel"), 
            this.__refactorClass(t, this.conf.classNames.vertical, "vertical"), this.__refactorClass(t, this.conf.classNames.inset, "inset"), 
            t.filter("." + $.inset).addClass($.nopanel), t.hasClass($.nopanel)) return !1;
            ...
            var i = t.parent("li");
            return e ? t.add(i).addClass($.vertical) : t.appendTo(this.$pnls), i.length && (i.data(z.child, t), 
            t.data(z.parent, i)), this.trigger("initPanel:after", t), t;
        },
        _initNavbar: function(t) {
            if (this.trigger("initNavbar:before", t), !t.children("." + $.navbar).length) {
                var e = t.data(z.parent), n = H('<div class="' + $.navbar + '" />'), i = H[F].i18n(this.opts.navbar.title), o = "";
                if (e && e.length) {
                    if (e.hasClass($.vertical)) return;
                    if (e.parent().is("." + $.listview)) var r = e.children("a, span").not("." + $.next); else r = e.closest("." + $.panel).find('a[href="#' + t.attr("id") + '"]');
                    var s = (e = (r = r.first()).closest("." + $.panel)).attr("id");
                    switch (i = r.text(), this.opts.navbar.titleLink) {
                      case "anchor":
                        o = r.attr("href");
                        break;
                ...
                this.opts.navbar.add && t.addClass($.hasnavbar), n.append('<a class="' + $.title + '"' + (o.length ? ' href="' + o + '"' : "") + ">" + i + "</a>").prependTo(t), 
        ...
        _initListview: function(t) {
            ...
            var i = t.data(z.parent);
            if (i && i.parent().is("." + $.listview) && !i.children("." + $.next).length) {
                var o = i.children("a, span").first(), r = H('<a class="' + $.next + '" href="#' + t.attr("id") + '" />').insertBefore(o);
                o.is("span") && r.addClass($.fullsubopen);
            }
            this.trigger("initListview:after", t);
        },
        _initOpened: function() {
            this.trigger("initOpened:before");
            var t = this.$pnls.find("." + $.listview).children("." + $.selected).removeClass($.selected).last().addClass($.selected), e = t.length ? t.closest("." + $.panel) : this.$pnls.children("." + $.panel).first();
            this.openPanel(e, !1), this.trigger("initOpened:after");
        },
        _initAnchors: function() {
            var l = this;
            R.$body.on(q.click + "-oncanvas", "a[href]", function(t) {
                var e = H(this), n = !1, i = l.$menu.find(e).length;
                for (var o in H[F].addons) if (H[F].addons[o].clickAnchor.call(l, e, i)) {
                    n = !0;
                    break;
                }
                var r = e.attr("href");
                if (!n && i && 1 < r.length && "#" == r.slice(0, 1)) try {
                    var s = H(r, l.$menu);
                    s.is("." + $.panel) && (n = !0, l[e.parent().hasClass($.vertical) ? "togglePanel" : "openPanel"](s));
                } catch (t) {}
                if (n && t.preventDefault(), !n && i && e.is("." + $.listview + " > li > a") && !e.is('[rel="external"]') && !e.is('[target="_blank"]')) {
                    l.__valueOrFn(l.opts.onClick.setSelected, e) && l.setSelected(H(t.target).parent());
                    var a = l.__valueOrFn(l.opts.onClick.preventDefault, e, "#" == r.slice(0, 1));
                    a && t.preventDefault(), l.__valueOrFn(l.opts.onClick.close, e, a) && l.opts.offCanvas && "function" == typeof l.close && l.close();
                }
            });
        },
        _initMatchMedia: function() {
            var e = this;
            this._fireMatchMedia(), R.$wndw.on(q.resize, function(t) {
                e._fireMatchMedia();
            });
        },
        ...
        __transitionend: function(e, n, t) {
            function i(t) {
                void 0 !== t && t.target != e[0] || (o || (e.off(q.transitionend), e.off(q.webkitTransitionEnd), 
                n.call(e[0])), o = !0);
            }
            var o = !1;
            e.on(q.transitionend, i), e.on(q.webkitTransitionEnd, i), setTimeout(i, 1.1 * t);
        },
        __getUniqueId: function() {
            return $.mm(H[F].uniqueId++);
        }
    }, H.fn[F] = function(n, i) {
        H[F].glbl || (R = {
            $wndw: H(window),
            ...
            $html: H("html"),
            $body: H("body")
        }, $ = {}, z = {}, q = {}, H.each([ $, z, q ], function(t, i) {
            i.add = function(t) {
                for (var e = 0, n = (t = t.split(" ")).length; e < n; e++) i[t[e]] = i.mm(t[e]);
            };
        }), $.mm = function(t) {
            return "mm-" + t;
        }, $.add("wrapper menu panels panel nopanel highest opened subopened navbar hasnavbar title btn prev next listview nolistview inset vertical selected divider spacer hidden fullsubopen noanimation"), 
        $.umm = function(t) {
            return "mm-" == t.slice(0, 3) && (t = t.slice(3)), t;
        }, z.mm = function(t) {
            return "mm-" + t;
        }, z.add("parent child"), q.mm = function(t) {
            return t + ".mm";
        }, q.add("transitionend webkitTransitionEnd click scroll resize keydown mousedown mouseup touchstart touchmove touchend orientationchange"), 
        H[F]._c = $, H[F]._d = z, H[F]._e = q, H[F].glbl = R), n = H.extend(!0, {}, H[F].defaults, n), 
        ...
        return this.each(function() {
            ...
            if (!t.data(F)) {
                var e = new H[F](t, n, i);
                e.$menu.data(F, e.__api()), o = o.add(e.$menu);
            }
        }), o;
    }, H[F].i18n = (W = {}, function(t) {
        switch (typeof t) {
          case "object":
            return H.extend(W, t), W;
        ...
        setup: function() {
            if (this.opts[M]) {
                var i = this, t = this.opts[M], o = this.conf[M];
                L = I[j].glbl, this._api = I.merge(this._api, [ "open", "close", "setPage" ]), "object" != typeof t && (t = {}), 
                "top" != t.position && "bottom" != t.position || (t.zposition = "front"), t = this.opts[M] = I.extend(!0, {}, I[j].defaults[M], t), 
                "string" != typeof o.pageSelector && (o.pageSelector = "> " + o.pageNodetype), this.vars.opened = !1;
                var r = [ N.offcanvas ];
                "left" != t.position && r.push(N.mm(t.position)), "back" != t.zposition && r.push(N.mm(t.zposition)), 
                I[j].support.csstransforms || r.push(N["no-csstransforms"]), I[j].support.csstransforms3d || r.push(N["no-csstransforms3d"]), 
                this.bind("initMenu:after", function() {
                    var t = this;
                    this.setPage(L.$page), this._initBlocker(), this["_initWindow_" + M](), this.$menu.addClass(r.join(" ")).parent("." + N.wrapper).removeClass(N.wrapper), 
                    ...
                    for (var n = [ N.mm("widescreen"), N.mm("iconbar") ], t = 0; t < n.length; t++) for (var e in this.opts.extensions) if (-1 < this.opts.extensions[e].indexOf(n[t])) {
                        !function(t, e) {
                            i.matchMedia(t, function() {
                                L.$html.addClass(n[e]);
                            }, function() {
                                L.$html.removeClass(n[e]);
                            });
                        }(e, t);
                        break;
                    }
        ...
        add: function() {
            N = I[j]._c, O = I[j]._d, P = I[j]._e, N.add("offcanvas slideout blocking modal background opening blocker page no-csstransforms3d"), 
            O.add("style");
        },
        clickAnchor: function(t, e) {
            ...
            if (this.opts[M]) {
                ...
                if (L.$page) return (i = L.$page.first().attr("id")) && t.is('[href="#' + i + '"]') ? (this.close(), 
                !0) : void 0;
            }
        }
    }, I[j].defaults[M] = {
        ...
        var t = this, e = this.opts[M];
        this.closeAllOthers(), L.$page.each(function() {
            I(this).data(O.style, I(this).attr("style") || "");
        }), L.$wndw.trigger(P.resize + "-" + M, [ !0 ]);
        var n = [ N.opened ];
        e.blockUI && n.push(N.blocking), "modal" == e.blockUI && n.push(N.modal), e.moveBackground && n.push(N.background), 
        "left" != e.position && n.push(N.mm(this.opts[M].position)), "back" != e.zposition && n.push(N.mm(this.opts[M].zposition)), 
        L.$html.addClass(n.join(" ")), setTimeout(function() {
            t.vars.opened = !0;
        ...
        if (this.trigger("close:before"), this.vars.opened) {
            ...
            }, this.conf.transitionDuration), this.trigger("close:start"), L.$html.removeClass(N.opening), 
        ...
        var e = this, n = this.conf[M];
        t && t.length || (t = L.$body.find(n.pageSelector), n.noPageSelector.length && (t = t.not(n.noPageSelector.join(", "))), 
        1 < t.length && n.wrapPageIfNeeded && (t = t.wrapAll("<" + this.conf[M].pageNodetype + " />").parent())), 
        t.each(function() {
        ...
        L.$wndw.off(P.resize + "-" + M).on(P.resize + "-" + M, function(t, e) {
            if (1 == L.$page.length && (e || L.$html.hasClass(N.opened))) {
                var n = L.$wndw.height();
                !e && n == i || (i = n, L.$page.css("minHeight", n));
            }
        });
    }, I[j].prototype._initBlocker = function() {
        var e = this;
        this.opts[M].blockUI && (L.$blck || (L.$blck = I('<div id="' + N.blocker + '" class="' + N.slideout + '" />')), 
        L.$blck.appendTo(L.$body).off(P.touchstart + "-" + M + " " + P.touchmove + "-" + M).on(P.touchstart + "-" + M + " " + P.touchmove + "-" + M, function(t) {
    ...
    }, D = "scrollBugFix", (E = t)[A = "mmenu"].addons[D] = {
        setup: function() {
            var t = this.opts[D];
            this.conf[D], k = E[A].glbl, E[A].support.touch && this.opts.offCanvas && this.opts.offCanvas.blockUI && ("boolean" == typeof t && (t = {
                fix: t
            }), "object" != typeof t && (t = {}), (t = this.opts[D] = E.extend(!0, {}, E[A].defaults[D], t)).fix && (this.bind("open:start", function() {
        ...
        add: function() {
            T = E[A]._c, E[A]._d, S = E[A]._e;
        },
        clickAnchor: function(t, e) {}
    }, E[A].defaults[D] = {
        fix: !0
    }, E[A].prototype["_initWindow_" + D] = function() {
        var t = this;
        k.$docu.off(S.touchmove + "-" + D).on(S.touchmove + "-" + D, function(t) {
            k.$html.hasClass(T.opened) && t.preventDefault();
        });
        var e = !1;
        k.$body.off(S.touchstart + "-" + D).on(S.touchstart + "-" + D, "." + T.panels + "> ." + T.panel, function(t) {
            k.$html.hasClass(T.opened) && (e || (e = !0, 0 === t.currentTarget.scrollTop ? t.currentTarget.scrollTop = 1 : t.currentTarget.scrollHeight === t.currentTarget.scrollTop + t.currentTarget.offsetHeight && --t.currentTarget.scrollTop, 
            e = !1));
        }).off(S.touchmove + "-" + D).on(S.touchmove + "-" + D, "." + T.panels + "> ." + T.panel, function(t) {
            k.$html.hasClass(T.opened) && E(this)[0].scrollHeight > E(this).innerHeight() && t.stopPropagation();
        }), k.$wndw.off(S.orientationchange + "-" + D).on(S.orientationchange + "-" + D, function() {
        ...
        setup: function() {
            var r = this, t = this.opts[x], s = this.conf[x];
            _[C].glbl, "boolean" == typeof t && (t = {
                aria: t,
                text: t
            }), "object" != typeof t && (t = {}), (t = this.opts[x] = _.extend(!0, {}, _[C].defaults[x], t)).aria && (this.bind("initAddons:after", function() {
                this.bind("initMenu:after", function() {
                ...
                var e = this.$menu.find("." + b.panel).not(t).not(t.parents("." + b.panel)), n = t.add(t.find("." + b.vertical + "." + b.opened).children("." + b.panel));
                ...
                var e = t.children("." + b.navbar), n = !!e.children("." + b.prev).length;
                ...
                var e = t.children("." + b.navbar), n = e.children("." + b.title).text(), i = _[C].i18n(s.text.closeSubmenu);
                n && (i += " (" + n + ")"), e.children("." + b.prev).html(this.__sr_text(i));
            }), this.bind("initListview:after", function(t) {
                var e = t.data(w.parent);
                if (e && e.length) {
                    var n = e.children("." + b.next), i = n.nextAll("span, a").first().text(), o = _[C].i18n(s.text[n.parent().is("." + b.vertical) ? "toggleSubmenu" : "openSubmenu"]);
                    i && (o += " (" + i + ")"), n.html(r.__sr_text(o));
                }
            }));
        },
        add: function() {
        ...
        setup: function() {
            var o = this.opts[y];
            if (this.conf[y], r[f].glbl, "boolean" == typeof o && o && (o = {
                height: "auto"
            }), "string" == typeof o && (o = {
                height: o
            }), "object" != typeof o && (o = {}), "auto" == (o = this.opts[y] = r.extend(!0, {}, r[f].defaults[y], o)).height || "highest" == o.height) {
                this.bind("initMenu:after", function() {
                    this.$menu.addClass(h.autoheight);
                });
                function t(t) {
                    if (!this.opts.offCanvas || this.vars.opened) {
                        var e = Math.max(parseInt(this.$pnls.css("top"), 10), 0) || 0, n = Math.max(parseInt(this.$pnls.css("bottom"), 10), 0) || 0, i = 0;
                        this.$menu.addClass(h.measureheight), "auto" == o.height ? ((t = t || this.$pnls.children("." + h.opened)).is("." + h.vertical) && (t = t.parents("." + h.panel).not("." + h.vertical)), 
                        t.length || (t = this.$pnls.children("." + h.panel)), i = t.first().outerHeight()) : "highest" == o.height && this.$pnls.children().each(function() {
                            var t = r(this);
                            t.is("." + h.vertical) && (t = t.parents("." + h.panel).not("." + h.vertical).first()), 
                            i = Math.max(i, t.outerHeight());
                        }), this.$menu.height(i + e + n).removeClass(h.measureheight);
                    }
                }
                this.opts.offCanvas && this.bind("open:start", t), "highest" == o.height && this.bind("initPanels:after", t), 
                "auto" == o.height && (this.bind("updateListview", t), this.bind("openPanel:start", t), 
        ...
        setup: function() {
            if (this.opts.offCanvas) {
                var r = (this.opts[u], this.conf[u]);
                l = s[c].glbl;
                this.bind("setPage:after", function(t) {
                    var e = this.conf.classNames[u].fixed, n = t.find("." + e);
                    this.__refactorClass(n, e, "slideout"), n[r.elemInsertMethod](r.elemInsertSelector);
                    var i = this.conf.classNames[u].sticky, o = t.find("." + i);
        ...
        setup: function() {
            var c = this, u = this.opts[v], h = this.conf[v];
            if (p[m].glbl, void 0 !== u) {
                u instanceof Array || (u = [ u ]);
                var d = {}, f = {};
                u.length && (p.each(u, function(t) {
                    var e = u[t];
                    "boolean" == typeof e && e && (e = {}), "object" != typeof e && (e = {}), void 0 === e.content && (e.content = [ "prev", "title" ]), 
                    e.content instanceof Array || (e.content = [ e.content ]), e = p.extend(!0, {}, c.opts.navbar, e);
                    var n = p('<div class="' + g.navbar + '" />'), i = e.height;
                    "number" != typeof i && (i = 1), i = Math.min(4, Math.max(1, i)), n.addClass(g.navbar + "-size-" + i);
                    var o = e.position;
                    "bottom" != o && (o = "top"), d[o] || (d[o] = 0), d[o] += i, f[o] || (f[o] = p('<div class="' + g.navbars + "-" + o + '" />')), 
                    f[o].append(n);
                    for (var r = 0, s = 0, a = e.content.length; s < a; s++) {
                        var l = p[m].addons[v][e.content[s]] || !1;
                        l ? r += l.call(c, n, e, h) : ((l = e.content[s]) instanceof p || (l = p(e.content[s])), 
                        n.append(l));
                    }
                    1 < (r += Math.ceil(n.children().not("." + g.btn).length / i)) && n.addClass(g.navbar + "-content-" + r), 
                    n.children("." + g.btn).length && n.addClass(g.hasbtns);
                }), this.bind("initMenu:after", function() {
                    for (var t in d) this.$menu.addClass(g.hasnavbar + "-" + t + "-" + d[t]), this.$menu["bottom" == t ? "append" : "prepend"](f[t]);
                }));
            }
        },
        add: function() {
        ...
        setup: function() {
            var t = this.opts.rtl;
            this.conf.rtl, i = e[o].glbl, "object" != typeof t && (t = {
                use: t
            }), "boolean" != typeof (t = this.opts.rtl = e.extend(!0, {}, e[o].defaults.rtl, t)).use && (t.use = "rtl" == (i.$html.attr("dir") || "").toLowerCase()), 
            t.use && this.bind("initMenu:after", function() {
    ...
    function n(h) {
        return function(t) {
            ...
            if (i) for (var o = 0, r = i.length; o < r; ++o) {
                var s = i[o].match(/%(-|!)?([a-zA-Z]{1})(:[^;]+;)?/), a = (e = s[0], n = e.toString().replace(/([.?*+^$[\]\\(){}|-])/g, "\\$1"), 
                new RegExp(n)), l = s[1] || "", c = s[3] || "", u = null;
                s = s[2], d.hasOwnProperty(s) && (u = d[s], u = Number(h[u])), null !== u && ("!" === l && (u = f(c, u)), 
                "" === l && u < 10 && (u = "0" + u.toString()), t = t.replace(a, u.toString()));
            }
            return t = t.replace(/%%/, "%");
        };
    }
    function f(t, e) {
        var n = "s", i = "";
        return t && (n = 1 === (t = t.replace(/(:|;|\s)/gi, "").split(/\,/)).length ? t[0] : (i = t[0], 
        t[1])), 1 < Math.abs(e) ? n : i;
    }
    function s(t, e, n) {
        this.el = t, this.$el = o(t), this.interval = null, this.offset = {}, this.options = o.extend({}, i), 
        this.firstTick = !0, this.instanceNumber = r.length, r.push(this), this.$el.data("countdown-instance", this.instanceNumber), 
        n && ("function" == typeof n ? (this.$el.on("update.countdown", n), this.$el.on("stoped.countdown", n), 
        this.$el.on("finish.countdown", n)) : this.options = o.extend({}, i, n)), this.setFinalDate(e), 
    ...
    o.extend(s.prototype, {
        ...
        update: function() {
            if (0 !== this.$el.closest("html").length) {
                var t, e = new Date();
                t = this.finalDate.getTime() - e.getTime(), t = Math.ceil(t / 1e3), t = !this.options.elapse && t < 0 ? 0 : Math.abs(t), 
        ...
        dispatchEvent: function(t) {
            ...
            e.finalDate = this.finalDate, e.elapsed = this.elapsed, e.offset = o.extend({}, this.offset), 
            e.strftime = n(this.offset), this.$el.trigger(e);
        }
    ...
    function d(t, e, n, i) {
        ...
        return o.className = "mfp-" + t, n && (o.innerHTML = n), i ? e && e.appendChild(o) : (o = u(o), 
        e && o.appendTo(e)), o;
    }
    function f(t, e) {
        g.ev.triggerHandler("mfp" + t, e), g.st.callbacks && (t = t.charAt(0).toLowerCase() + t.slice(1), 
        g.st.callbacks[t] && g.st.callbacks[t].apply(g, u.isArray(e) ? e : [ e ]));
    }
    function p(t) {
        return t === e && g.currTemplate.closeBtn || (g.currTemplate.closeBtn = u(g.st.closeMarkup.replace("%title%", g.st.tClose)), 
        e = t), g.currTemplate.closeBtn;
    }
    function r() {
        u.magnificPopup.instance || ((g = new t()).init(), u.magnificPopup.instance = g);
    }
    var g, i, m, o, v, e, l = "Close", c = "BeforeClose", y = "MarkupParse", _ = "Open", b = ".mfp", w = "mfp-ready", n = "mfp-removing", s = "mfp-prevent-close", a = !!window.jQuery, C = u(window);
    t.prototype = {
        constructor: t,
        init: function() {
            var t = navigator.appVersion;
            g.isLowIE = g.isIE8 = document.all && !document.addEventListener, g.isAndroid = /android/gi.test(t), 
            g.isIOS = /iphone|ipad|ipod/gi.test(t), g.supportsTransition = function() {
        ...
        open: function(t) {
            ...
            if (!1 === t.isObj) {
                ...
                var n, i = t.items;
                for (e = 0; e < i.length; e++) if ((n = i[e]).parsed && (n = n.el[0]), n === t.el[0]) {
                    g.index = e;
                    break;
                }
            } else g.items = u.isArray(t.items) ? t.items : [ t.items ], g.index = t.index || 0;
            if (!g.isOpen) {
                g.types = [], v = "", t.mainEl && t.mainEl.length ? g.ev = t.mainEl.eq(0) : g.ev = m, 
                t.key ? (g.popupsCache[t.key] || (g.popupsCache[t.key] = {}), g.currTemplate = g.popupsCache[t.key]) : g.currTemplate = {}, 
                g.st = u.extend(!0, {}, u.magnificPopup.defaults, t), g.fixedContentPos = "auto" === g.st.fixedContentPos ? !g.probablyMobile : g.st.fixedContentPos, 
                g.st.modal && (g.st.closeOnContentClick = !1, g.st.closeOnBgClick = !1, g.st.showCloseBtn = !1, 
                g.st.enableEscapeKey = !1), g.bgOverlay || (g.bgOverlay = d("bg").on("click" + b, function() {
                    g.close();
                ...
                }), v += " mfp-close-btn-in") : g.wrap.append(p())), g.st.alignTop && (v += " mfp-align-top"), 
                ...
                return g.isIE7 && (c += " mfp-ie7"), c && g._addClassToMFP(c), g.updateItemHTML(), 
                f("BuildControls"), u("html").css(a), g.bgOverlay.add(g.wrap).prependTo(g.st.prependTo || u(document.body)), 
                ...
                }, 16), g.isOpen = !0, g.updateSize(s), f(_), t;
            }
            g.updateItemHTML();
        },
        close: function() {
            g.isOpen && (f(c), g.isOpen = !1, g.st.removalDelay && !g.isLowIE && g.supportsTransition ? (g._addClassToMFP(n), 
            setTimeout(function() {
                g._close();
        ...
        _close: function() {
            f(l);
            var t = n + " " + w + " ";
            if (g.bgOverlay.detach(), g.wrap.detach(), g.container.empty(), g.st.mainClass && (t += g.st.mainClass + " "), 
            g._removeClassFromMFP(t), g.fixedContentPos) {
                var e = {
                    marginRight: ""
                };
                g.isIE7 ? u("body, html").css("overflow", "") : e.overflow = "", u("html").css(e);
            }
            m.off("keyup.mfp focusin" + b), g.ev.off(b), g.wrap.attr("class", "mfp-wrap").removeAttr("style"), 
        ...
        updateSize: function(t) {
            if (g.isIOS) {
                var e = document.documentElement.clientWidth / window.innerWidth, n = window.innerHeight * e;
                g.wrap.css("height", n), g.wH = n;
            } else g.wH = t || C.height();
        ...
        updateItemHTML: function() {
            ...
            var e = t.type;
            if (f("BeforeChange", [ g.currItem ? g.currItem.type : "", e ]), g.currItem = t, 
            !g.currTemplate[e]) {
                var n = !!g.st[e] && g.st[e].markup;
                f("FirstMarkupParse", n), g.currTemplate[e] = !n || u(n);
            }
            o && o !== t.type && g.container.removeClass("mfp-" + o + "-holder");
            var i = g["get" + e.charAt(0).toUpperCase() + e.slice(1)](t, g.currTemplate[e]);
            g.appendContent(i, e), t.preloaded = !0, f("Change", t), o = t.type, g.container.prepend(g.contentContainer), 
            f("AfterChange");
        },
        appendContent: function(t, e) {
            (g.content = t) ? g.st.showCloseBtn && g.st.closeBtnInside && !0 === g.currTemplate[e] ? g.content.find(".mfp-close").length || g.content.append(p()) : g.content = t : g.content = "", 
            f("BeforeAppend"), g.container.addClass("mfp-" + e + "-holder"), g.contentContainer.append(g.content);
        },
        parseEl: function(t) {
            var e, n = g.items[t];
            if ((n = n.tagName ? {
                ...
                for (var i = g.types, o = 0; o < i.length; o++) if (n.el.hasClass("mfp-" + i[o])) {
                    e = i[o];
                    break;
                }
                n.src = n.el.attr("data-mfp-src"), n.src || (n.src = n.el.attr("href"));
            }
            return n.type = e || g.st.type || "inline", n.index = t, n.parsed = !0, g.items[t] = n, 
            f("ElementParse", n), g.items[t];
        },
        addGroup: function(e, n) {
            ...
            (n = n || {}).mainEl = e, n.items ? (n.isObj = !0, e.off(i).on(i, t)) : (n.isObj = !1, 
            n.delegate ? e.off(i).on(i, n.delegate, t) : (n.items = e).off(i).on(i, t));
        },
        _openClick: function(t, e, n) {
            if ((void 0 !== n.midClick ? n.midClick : u.magnificPopup.defaults.midClick) || !(2 === t.which || t.ctrlKey || t.metaKey || t.altKey || t.shiftKey)) {
                ...
                t.type && (t.preventDefault(), g.isOpen && t.stopPropagation()), n.el = u(t.mfpEl), 
                n.delegate && (n.items = e.find(n.delegate)), g.open(n);
            }
        },
        updateStatus: function(t, e) {
            if (g.preloader) {
                i !== t && g.container.removeClass("mfp-s-" + i), e || "loading" !== t || (e = g.st.tLoading);
                var n = {
                    status: t,
                    text: e
                };
                f("UpdateStatus", n), t = n.status, e = n.text, g.preloader.html(e), g.preloader.find("a").on("click", function(t) {
        ...
        _checkIfClose: function(t) {
            if (!u(t).hasClass(s)) {
                var e = g.st.closeOnContentClick, n = g.st.closeOnBgClick;
                if (e && n) return !0;
        ...
        _onFocusIn: function(t) {
            if (t.target !== g.wrap[0] && !u.contains(g.wrap[0], t.target)) return g._setFocus(), 
            !1;
        },
        ...
        _getScrollbarSize: function() {
            if (void 0 === g.scrollbarSize) {
                ...
                document.body.appendChild(t), g.scrollbarSize = t.offsetWidth - t.clientWidth, document.body.removeChild(t);
            }
        ...
        registerModule: function(t, e) {
            e.options && (u.magnificPopup.defaults[t] = e.options), u.extend(this.proto, e.proto), 
            this.modules.push(t);
        },
        defaults: {
            disableOn: 0,
        ...
        if ("string" == typeof t) if ("open" === t) {
            var n, i = a ? e.data("magnificPopup") : e[0].magnificPopup, o = parseInt(arguments[1], 10) || 0;
            n = i.items ? i.items[o] : (n = e, i.delegate && (n = n.find(i.delegate)), n.eq(o)), 
            g._openClick({
                mfpEl: n
            }, e, i);
        } else g.isOpen && g[t].apply(g, Array.prototype.slice.call(arguments, 1)); else t = u.extend(!0, {}, t), 
        a ? e.data("magnificPopup", t) : e[0].magnificPopup = t, g.addGroup(e, t);
        return e;
    };
    function x() {
    ...
    u.magnificPopup.registerModule(k, {
        ...
        proto: {
            initInline: function() {
                g.types.push(k), h(l + "." + k, function() {
                    x();
                });
            },
            getInline: function(t, e) {
                if (x(), t.src) {
                    var n = g.st.inline, i = u(t.src);
                    if (i.length) {
                        var o = i[0].parentNode;
                        o && o.tagName && (T || (E = n.hiddenClass, T = d(E), E = "mfp-" + E), S = i.after(T).detach().removeClass(E)), 
            ...
            getAjax: function(o) {
                ...
                var t = u.extend({
                    ...
                    success: function(t, e, n) {
                        ...
                        f("ParseAjax", i), g.appendContent(u(i.data), N), o.finished = !0, A(), g._setFocus(), 
                        setTimeout(function() {
                            g.wrap.addClass(w);
                        }, 16), g.updateStatus("ready"), f("AjaxContentAdded");
                    },
                    error: function() {
                        A(), o.finished = o.loadError = !0, g.updateStatus("error", g.st.ajax.tError.replace("%url%", o.src));
                    }
                }, g.st.ajax.settings);
        ...
        proto: {
            ...
            resizeImage: function() {
                ...
                if (t && t.img && g.st.image.verticalFit) {
                    var e = 0;
                    g.isLowIE && (e = parseInt(t.img.css("padding-top"), 10) + parseInt(t.img.css("padding-bottom"), 10)), 
                    t.img.css("max-height", g.wH - e);
                }
            },
            _onImageHasSize: function(t) {
                t.img && (t.hasSize = !0, O && clearInterval(O), t.isCheckingImgSize = !1, f("ImageHasSize", t), 
                t.imgHidden && (g.content && g.content.removeClass("mfp-loading"), t.imgHidden = !1));
            },
            findImageSize: function(e) {
                var n = 0, i = e.img[0], o = function(t) {
            ...
            getImage: function(t, e) {
                var n = 0, i = function() {
                    t && (t.img[0].complete ? (t.img.off(".mfploader"), t === g.currItem && (g._onImageHasSize(t), 
                    g.updateStatus("ready")), t.hasSize = !0, t.loaded = !0, f("ImageLoadComplete")) : ++n < 200 ? setTimeout(i, 100) : o());
                }, o = function() {
                    t && (t.img.off(".mfploader"), t === g.currItem && (g._onImageHasSize(t), g.updateStatus("error", r.tError.replace("%url%", t.src))), 
                    t.hasSize = !0, t.loaded = !0, t.loadError = !0);
                }, r = g.st.image, s = e.find(".mfp-img");
                if (s.length) {
                    var a = document.createElement("img");
                    a.className = "mfp-img", t.el && t.el.find("img").length && (a.alt = t.el.find("img").attr("alt")), 
                    t.img = u(a).on("load.mfploader", i).on("error.mfploader", o), a.src = t.src, s.is("img") && (t.img = t.img.clone()), 
                    0 < (a = t.img[0]).naturalWidth ? t.hasSize = !0 : a.width || (t.hasSize = !1);
                }
                return g._parseMarkup(e, {
                    title: function(t) {
                ...
                }, t), g.resizeImage(), t.hasSize ? (O && clearInterval(O), t.loadError ? (e.addClass("mfp-loading"), 
                g.updateStatus("error", r.tError.replace("%url%", t.src))) : (e.removeClass("mfp-loading"), 
                g.updateStatus("ready"))) : (g.updateStatus("loading"), t.loading = !0, t.hasSize || (t.imgHidden = !0, 
                e.addClass("mfp-loading"), g.findImageSize(t))), e;
            }
        }
    });
    var P;
    u.magnificPopup.registerModule("zoom", {
        ...
        proto: {
            initZoom: function() {
                var t, r = g.st.zoom, e = ".zoom";
                if (r.enabled && g.supportsTransition) {
                    function n(t) {
                        var e = t.clone().removeAttr("style").removeAttr("class").addClass("mfp-animated-image"), n = "all " + r.duration / 1e3 + "s " + r.easing, i = {
                            position: "fixed",
                            zIndex: 9999,
                            left: 0,
                            top: 0,
                    ...
                    h("BuildControls" + e, function() {
                        if (g._allowZoom()) {
                            ...
                            (s = n(t)).css(g._getOffset()), g.wrap.append(s), o = setTimeout(function() {
                                s.css(g._getOffset(!0)), o = setTimeout(function() {
                        ...
                        if (g._allowZoom()) {
                            if (clearTimeout(o), g.st.removalDelay = a, !t) {
                                if (!(t = g._getItemToZoom())) return;
                                s = n(t);
                            }
                            s.css(g._getOffset(!0)), g.wrap.append(s), g.content.css("visibility", "hidden"), 
                            setTimeout(function() {
                                s.css(g._getOffset());
                            }, 16);
                        }
                    }), h(l + e, function() {
                        g._allowZoom() && (i(), s && s.remove(), t = null);
                    });
                }
            },
            _allowZoom: function() {
            ...
            _getOffset: function(t) {
                var e, n = (e = t ? g.currItem.img : g.st.zoom.opener(g.currItem.el || g.currItem)).offset(), i = parseInt(e.css("padding-top"), 10), o = parseInt(e.css("padding-bottom"), 10);
                ...
                P ? r["-moz-transform"] = r.transform = "translate(" + n.left + "px," + n.top + "px)" : (r.left = n.left, 
                r.top = n.top), r;
            }
        }
    });
    function L(t) {
        if (g.currTemplate[j]) {
            var e = g.currTemplate[j].find("iframe");
    ...
    u.magnificPopup.registerModule(j, {
        ...
        proto: {
            ...
            getIframe: function(t, e) {
                ...
                var o = {};
                return i.srcAction && (o[i.srcAction] = n), g._parseMarkup(e, o, t), g.updateStatus("ready"), 
                e;
            }
        }
    });
    ...
    u.magnificPopup.registerModule("gallery", {
        ...
        proto: {
            initGallery: function() {
                var r = g.st.gallery, t = ".mfp-gallery";
                ...
                v += " mfp-gallery", h(_ + t, function() {
                    ...
                    if (1 < g.items.length && r.arrows && !g.arrowLeft) {
                        var t = r.arrowMarkup, e = g.arrowLeft = u(t.replace(/%title%/gi, r.tPrev).replace(/%dir%/gi, "left")).addClass(s), n = g.arrowRight = u(t.replace(/%title%/gi, r.tNext).replace(/%dir%/gi, "right")).addClass(s);
                        e.click(function() {
                            g.prev();
                        }), n.click(function() {
                            g.next();
            ...
            preloadNearbyImages: function() {
                var t, e = g.st.gallery.preload, n = Math.min(e[0], g.items.length), i = Math.min(e[1], g.items.length);
            ...
            _preloadItem: function(t) {
                if (t = M(t), !g.items[t].preloaded) {
                    var e = g.items[t];
                    e.parsed || (e = g.parseEl(t)), f("LazyLoad", e), "image" === e.type && (e.img = u('<img class="mfp-img" />').on("load.mfploader", function() {
                        e.hasSize = !0;
        ...
        proto: {
            initRetina: function() {
                if (1 < window.devicePixelRatio) {
                    ...
                    1 < (i = isNaN(i) ? i() : i) && (h("ImageHasSize." + $, function(t, e) {
                        e.img.css({
    ...
    var i, t, n, l, o, s = [].indexOf || function(t) {
    ...
    function u(t) {
        null == t && (t = {}), this.scrollCallback = e(this.scrollCallback, this), this.scrollHandler = e(this.scrollHandler, this), 
        this.resetAnimation = e(this.resetAnimation, this), this.start = e(this.start, this), 
    ...
    r.prototype.extend = function(t, e) {
        ...
        var o;
        return null == e && (e = !1), null == n && (n = !1), null == i && (i = null), null != document.createEvent ? (o = document.createEvent("CustomEvent")).initCustomEvent(t, e, n, i) : null != document.createEventObject ? (o = document.createEventObject()).eventType = t : o.eventName = t, 
        o;
    ...
    }, a), i = this.MutationObserver || this.WebkitMutationObserver || this.MozMutationObserver || (c.notSupported = !0, 
    c.prototype.observe = function() {}, c), l = this.getComputedStyle || function(n, t) {
        ...
        if (this.stopped = !1, this.boxes = function() {
            var t, e, n, i;
            for (i = [], t = 0, e = (n = this.element.querySelectorAll("." + this.config.boxClass)).length; t < e; t++) o = n[t], 
            i.push(o);
            return i;
        ...
        e = (n = this.boxes).length; t < e; t++) o = n[t], this.applyStyle(o, !0);
        ...
        this.config.live) return new i((s = this, function(t) {
            var e, n, o, r, i;
        ...
        if (null == t && (t = this.element), 1 === t.nodeType) {
            for (r = [], n = 0, i = (o = (t = t.parentNode || t).querySelectorAll("." + this.config.boxClass)).length; n < i; n++) e = o[n], 
            s.call(this.all, e) < 0 ? (this.boxes.push(e), this.all.push(e), this.stopped || this.disabled() ? this.resetStyle() : this.applyStyle(e, !0), 
        ...
        var n, i, o, r;
        return i = t.getAttribute("data-wow-duration"), n = t.getAttribute("data-wow-delay"), 
        o = t.getAttribute("data-wow-iteration"), this.animate((r = this, function() {
        ...
        for (r in e = [], t) s = t[r], o["" + r] = s, e.push(function() {
            var t, e, n, i;
            for (i = [], t = 0, e = (n = this.vendors).length; t < e; t++) a = n[t], i.push(o["" + a + r.charAt(0).toUpperCase() + r.substr(1)] = s);
            return i;
        }.call(this));
        return e;
    }, u.prototype.vendorCSS = function(t, e) {
        var n, i, o, r, s, a;
        for (r = (s = l(t)).getPropertyCSSValue(e), n = 0, i = (o = this.vendors).length; n < i; n++) a = o[n], 
        r = r || s.getPropertyCSSValue("-" + a + "-" + e);
        return r;
        ...
        var e, n, i, o, r;
        return n = t.getAttribute("data-wow-offset") || this.config.offset, o = (r = this.config.scrollContainer && this.config.scrollContainer.scrollTop || window.pageYOffset) + Math.min(this.element.clientHeight, this.util().innerHeight()) - n, 
        e = (i = this.offsetTop(t)) + t.clientHeight, i <= o && r <= e;
    ...
    r.fn.footerReveal = function(t) {
        var e = r(this), n = e.prev(), i = r(window), o = r.extend({
            shadow: !0,
            shadowOpacity: .8,
            zIndex: -100
        }, t);
    ...
    "use strict";
    function o(t, e) {
        var n, i = "LazyLoad::Initialized", o = new t(e);
        try {
            n = new CustomEvent(i, {
                detail: {
                    instance: o
    ...
    var t = "undefined" != typeof window, r = t && !("onscroll" in window) || "undefined" != typeof navigator && /(gle|ing|ro)bot|crawl|spider/i.test(navigator.userAgent), e = t && "IntersectionObserver" in window, c = t && "classList" in document.createElement("p"), n = {
    ...
    function m(t, e) {
        var n, i, o, r, s, a, l = e._settings, c = t.tagName, u = A[c];
        if (u) return u(t, l), f(e, 1), void (e._elements = (n = e._elements, i = t, n.filter(function(t) {
            return t !== i;
        })));
        s = h(o = t, (r = l).data_src), a = h(o, r.data_bg), s && (o.style.backgroundImage = 'url("'.concat(s, '")')), 
        a && (o.style.backgroundImage = a);
    }
    function v(t, e) {
    ...
    function w(t, e, n) {
        var i, o, r = n._settings, s = e ? r.class_loaded : r.class_error, a = e ? r.callback_loaded : r.callback_error, l = t.target;
        i = l, o = r.class_loading, c ? i.classList.remove(o) : i.className = i.className.replace(new RegExp("(^|\\s+)" + o + "(\\s+|$)"), " ").replace(/^\s+/, "").replace(/\s+$/, ""), 
        v(l, s), d(a, l), f(n, -1);
    }
    function C(n, i) {
        function o(t) {
    ...
    function x(a) {
        return e && (a._observer = new IntersectionObserver(function(t) {
            t.forEach(function(t) {
                return (s = t).isIntersecting || 0 < s.intersectionRatio ? (i = t.target, r = (o = a)._settings, 
                d(r.callback_enter, i), void (r.load_delay ? P : N)(i, o)) : (e = t.target, n = a._settings, 
                d(n.callback_exit, e), void (n.load_delay && O(e)));
                var e, n, i, o, r, s;
            });
        }, {
    ...
    var S = "was-processed", k = "ll-timeout", A = {
        IMG: function(t, e) {
            var n = t.parentNode;
    ...
    }, D = "loadeddata", I = [ "IMG", "IFRAME", "VIDEO" ], N = function(t, e) {
        var n = e._observer;
        ...
        var i = e._settings;
        !n && a(t) || (-1 < I.indexOf(t.tagName) && (C(t, e), v(t, i.class_loading)), m(t, e), 
        s(t, S, "true"), d(i.callback_reveal, t), d(i.callback_set, t));
    }, j = [ "IMG", "IFRAME" ];
    return T.prototype = {
        update: function(t) {
        ...
        if (e) if (e.length) for (var n, i = 0; n = e[i]; i += 1) o(t, n); else o(t, e);
    ...
    var g = {
        ...
        typeCheckConfig: function(t, e, n) {
            for (var i in n) if (Object.prototype.hasOwnProperty.call(n, i)) {
                var o = n[i], r = e[i], s = r && g.isElement(r) ? "element" : (a = r, {}.toString.call(a).match(/\s([a-z]+)/i)[1].toLowerCase());
    ...
    var r = "alert", a = "bs.alert", c = "." + a, u = p.fn[r], h = {
        CLOSE: "close" + c,
        CLOSED: "closed" + c,
        CLICK_DATA_API: "click" + c + ".data-api"
    }, d = "alert", f = "fade", m = "show", v = function() {
        function i(t) {
            this._element = t;
        }
        var t = i.prototype;
        return t.close = function(t) {
            ...
            var n = this;
            if (p(e).removeClass(m), p(e).hasClass(f)) {
    ...
    p(document).on(h.CLICK_DATA_API, '[data-dismiss="alert"]', v._handleDismiss(new v())), 
    p.fn[r] = v._jQueryInterface, p.fn[r].Constructor = v, p.fn[r].noConflict = function() {
        return p.fn[r] = u, v._jQueryInterface;
    };
    var y = "button", _ = "bs.button", b = "." + _, w = ".data-api", C = p.fn[y], x = "active", E = "btn", T = "focus", S = '[data-toggle^="button"]', k = '[data-toggle="buttons"]', A = '[data-toggle="button"]', D = '[data-toggle="buttons"] .btn', I = 'input:not([type="hidden"])', N = ".active", O = ".btn", P = {
        ...
        return t.toggle = function() {
            var t = !0, e = !0, n = p(this._element).closest(k)[0];
            if (n) {
                ...
                if (i) {
                    if ("radio" === i.type) if (i.checked && this._element.classList.contains(x)) t = !1; else {
                        ...
                        o && p(o).removeClass(x);
                    } else "checkbox" === i.type ? "LABEL" === this._element.tagName && i.checked === this._element.classList.contains(x) && (t = !1) : t = !1;
                    t && (i.checked = !this._element.classList.contains(x), p(i).trigger("change")), 
                    i.focus(), e = !1;
                }
            }
            this._element.hasAttribute("disabled") || this._element.classList.contains("disabled") || (e && this._element.setAttribute("aria-pressed", !this._element.classList.contains(x)), 
    ...
    p(document).on(P.CLICK_DATA_API, S, function(t) {
        ...
        for (var t = [].slice.call(document.querySelectorAll(D)), e = 0, n = t.length; e < n; e++) {
            var i = t[e], o = i.querySelector(I);
            o.checked || o.hasAttribute("checked") ? i.classList.add(x) : i.classList.remove(x);
        }
        for (var r = 0, s = (t = [].slice.call(document.querySelectorAll(A))).length; r < s; r++) {
            var a = t[r];
    ...
    var j = "carousel", M = "bs.carousel", H = "." + M, $ = ".data-api", z = p.fn[j], q = {
        interval: 5e3,
        keyboard: !0,
        slide: !1,
        pause: "hover",
        ...
        wrap: "boolean",
        touch: "boolean"
    }, W = "next", F = "prev", B = "left", U = "right", Q = {
        SLIDE: "slide" + H,
        SLID: "slid" + H,
        KEYDOWN: "keydown" + H,
    ...
    }, K = "carousel", V = "active", Y = "slide", X = "carousel-item-right", Z = "carousel-item-left", G = "carousel-item-next", J = "carousel-item-prev", tt = "pointer-event", et = ".active", nt = ".active.carousel-item", it = ".carousel-item", ot = ".carousel-item img", rt = ".carousel-item-next, .carousel-item-prev", st = ".carousel-indicators", at = "[data-slide], [data-slide-to]", lt = '[data-ride="carousel"]', ct = {
        TOUCH: "touch",
        PEN: "pen"
    }, ut = function() {
        function r(t, e) {
            ...
            this._config = this._getConfig(e), this._element = t, this._indicatorsElement = this._element.querySelector(st), 
        ...
        return t.next = function() {
            ...
            t || (this._isPaused = !0), this._element.querySelector(rt) && (g.triggerTransitionEnd(this._element), 
            ...
            p(this._element).off(H), p.removeData(this._element, M), this._items = null, this._config = null, 
            ...
            return t = l({}, q, {}, t), g.typeCheckConfig(j, t, R), t;
            ...
            if (this._touchSupported) {
                var e = function(t) {
                    n._pointerEvent && ct[t.originalEvent.pointerType.toUpperCase()] ? n.touchStartX = t.originalEvent.clientX : n._pointerEvent || (n.touchStartX = t.originalEvent.touches[0].clientX);
                }, i = function(t) {
                    n._pointerEvent && ct[t.originalEvent.pointerType.toUpperCase()] && (n.touchDeltaX = t.originalEvent.clientX - n.touchStartX), 
                ...
                p(this._element.querySelectorAll(ot)).on(Q.DRAG_START, function(t) {
                    ...
                    return i(t);
                }), this._element.classList.add(tt)) : (p(this._element).on(Q.TOUCHSTART, function(t) {
                    return e(t);
            ...
            return this._items = t && t.parentNode ? [].slice.call(t.parentNode.querySelectorAll(it)) : [], 
            this._items.indexOf(t);
        }, t._getItemByDirection = function(t, e) {
            var n = t === W, i = t === F, o = this._getItemIndex(e), r = this._items.length - 1;
            if ((i && 0 === o || n && o === r) && !this._config.wrap) return e;
            var s = (o + (t === F ? -1 : 1)) % this._items.length;
            return -1 == s ? this._items[this._items.length - 1] : this._items[s];
        }, t._triggerSlideEvent = function(t, e) {
            var n = this._getItemIndex(t), i = this._getItemIndex(this._element.querySelector(nt)), o = p.Event(Q.SLIDE, {
                relatedTarget: t,
                direction: e,
                from: i,
                to: n
            ...
            var n, i, o, r = this, s = this._element.querySelector(nt), a = this._getItemIndex(s), l = e || s && this._getItemByDirection(t, s), c = this._getItemIndex(l), u = Boolean(this._interval);
            if (o = t === W ? (n = Z, i = G, B) : (n = X, i = J, U), l && p(l).hasClass(V)) this._isSliding = !1; else if (!this._triggerSlideEvent(l, o).isDefaultPrevented() && s && l) {
            ...
            return this.each(function() {
                var t = p(this).data(M), e = l({}, q, {}, p(this).data());
            ...
            if (e) {
                ...
                if (n && p(n).hasClass(K)) {
                    ...
                    o && (i.interval = !1), r._jQueryInterface.call(p(n), i), o && p(n).data(M).to(o), 
                    t.preventDefault();
                }
            }
        }, s(r, null, [ {
    ...
    p(document).on(Q.CLICK_DATA_API, at, ut._dataApiClickHandler), p(window).on(Q.LOAD_DATA_API, function() {
        ...
        return p.fn[j] = z, ut._jQueryInterface;
    };
    var ht = "collapse", dt = "bs.collapse", ft = "." + dt, pt = p.fn[ht], gt = {
        toggle: !0,
        parent: ""
    }, mt = {
        toggle: "boolean",
    ...
    }, yt = "show", _t = "collapse", bt = "collapsing", wt = "collapsed", Ct = "width", xt = "height", Et = ".show, .collapsing", Tt = '[data-toggle="collapse"]', St = function() {
        function a(e, t) {
            ...
            for (var n = [].slice.call(document.querySelectorAll(Tt)), i = 0, o = n.length; i < o; i++) {
                var r = n[i], s = g.getSelectorFromElement(r), a = [].slice.call(document.querySelectorAll(s)).filter(function(t) {
                    return t === e;
                });
        ...
        return t.toggle = function() {
            ...
            var t, e, n = this;
            if (!this._isTransitioning && !p(this._element).hasClass(yt) && (this._parent && 0 === (t = [].slice.call(this._parent.querySelectorAll(Et)).filter(function(t) {
                return "string" == typeof n._config.parent ? t.getAttribute("data-parent") === n._config.parent : t.classList.contains(_t);
                ...
                if (p(this._element).trigger(i), !i.isDefaultPrevented()) {
                    ...
                    p(this._element).removeClass(_t).addClass(bt), this._element.style[o] = 0, this._triggerArray.length && p(this._triggerArray).removeClass(wt).attr("aria-expanded", !0), 
                    this.setTransitioning(!0);
                    var r = "scroll" + (o[0].toUpperCase() + o.slice(1)), s = g.getTransitionDurationFromElement(this._element);
                    p(this._element).one(g.TRANSITION_END, function() {
                        p(n._element).removeClass(bt).addClass(_t).addClass(yt), n._element.style[o] = "", 
                        n.setTransitioning(!1), p(n._element).trigger(vt.SHOWN);
            ...
            if (!this._isTransitioning && p(this._element).hasClass(yt)) {
                ...
                if (p(this._element).trigger(e), !e.isDefaultPrevented()) {
                    ...
                    p(this._element).addClass(bt).removeClass(_t).removeClass(yt);
                    var i = this._triggerArray.length;
                    if (0 < i) for (var o = 0; o < i; o++) {
                        var r = this._triggerArray[o], s = g.getSelectorFromElement(r);
                        if (null !== s) p([].slice.call(document.querySelectorAll(s))).hasClass(yt) || p(r).addClass(wt).attr("aria-expanded", !1);
                    }
                    this.setTransitioning(!0);
            ...
            p.removeData(this._element, dt), this._config = null, this._parent = null, this._element = null, 
            this._triggerArray = null, this._isTransitioning = null;
        }, t._getConfig = function(t) {
            return (t = l({}, gt, {}, t)).toggle = Boolean(t.toggle), g.typeCheckConfig(ht, t, mt), 
            t;
            ...
            return this.each(function() {
                var t = p(this), e = t.data(dt), n = l({}, gt, {}, t.data(), {}, "object" == typeof i && i ? i : {});
                if (!e && n.toggle && /show|hide/.test(i) && (n.toggle = !1), e || (e = new a(this, n), 
                t.data(dt, e)), "string" == typeof i) {
    ...
    p(document).on(vt.CLICK_DATA_API, Tt, function(t) {
        ...
        var n = p(this), e = g.getSelectorFromElement(this), i = [].slice.call(document.querySelectorAll(e));
        p(i).each(function() {
            var t = p(this), e = t.data(dt) ? "toggle" : n.data();
    ...
    var kt = "undefined" != typeof window && "undefined" != typeof document && "undefined" != typeof navigator, At = function() {
        for (var t = [ "Edge", "Trident", "Firefox" ], e = 0; e < t.length; e += 1) if (kt && 0 <= navigator.userAgent.indexOf(t[e])) return 1;
        return 0;
    }();
    var Dt = kt && window.Promise ? function(t) {
        var e = !1;
        return function() {
    ...
    var jt = kt && !(!window.MSInputMethodContext || !document.documentMode), Mt = kt && /MSIE 10/.test(navigator.userAgent);
    function Ht(t) {
        return 11 === t ? jt : 10 === t ? Mt : jt || Mt;
    }
    function $t(t) {
    ...
    function qt(t, e) {
        ...
        var c = zt(t);
        return c.host ? qt(c.host, e) : qt(t, zt(e).host);
    }
    function Rt(t, e) {
        var n = "top" === (1 < arguments.length && void 0 !== e ? e : "top") ? "scrollTop" : "scrollLeft", i = t.nodeName;
    ...
    function Bt(t) {
        ...
        return {
            height: Ft("Height", e, n, i),
            width: Ft("Width", e, n, i)
        };
    }
    ...
    function Xt(t) {
        ...
        }, r = "HTML" === t.nodeName ? Bt(t.ownerDocument) : {}, s = r.width || t.clientWidth || o.width, a = r.height || t.clientHeight || o.height, l = t.offsetWidth - s, c = t.offsetHeight - a;
        if (l || c) {
            var u = Nt(t);
    ...
    function Zt(t, e, n) {
        var i = 2 < arguments.length && void 0 !== n && n, o = Ht(10), r = "HTML" === e.nodeName, s = Xt(t), a = Xt(e), l = Pt(t), c = Nt(e), u = parseFloat(c.borderTopWidth, 10), h = parseFloat(c.borderLeftWidth, 10);
        ...
        if (d.marginTop = 0, d.marginLeft = 0, !o && r) {
            ...
            d.top -= u - f, d.bottom -= u - f, d.left -= h - p, d.right -= h - p, d.marginTop = f, 
            d.marginLeft = p;
        }
    ...
    function Jt(t, e, n, i, o) {
        var r = 4 < arguments.length && void 0 !== o && o, s = {
            top: 0,
            left: 0
        }, a = r ? Gt(t) : qt(t, Lt(e));
        if ("viewport" === i) s = function(t, e) {
            var n = 1 < arguments.length && void 0 !== e && e, i = t.ownerDocument.documentElement, o = Zt(t, i), r = Math.max(i.clientWidth, window.innerWidth || 0), s = Math.max(i.clientHeight, window.innerHeight || 0), a = n ? 0 : Rt(i), l = n ? 0 : Rt(i, "left");
            return Yt({
            ...
            var l = void 0;
            "scrollParent" === i ? "BODY" === (l = Pt(Ot(e))).nodeName && (l = t.ownerDocument.documentElement) : l = "window" === i ? t.ownerDocument.documentElement : i;
            var c = Zt(l, a, r);
            if ("HTML" !== l.nodeName || function t(e) {
                ...
                var u = Bt(t.ownerDocument), h = u.height, d = u.width;
                s.top += c.top - c.marginTop, s.bottom = h + c.top, s.left += c.left - c.marginLeft, 
                s.right = d + c.left;
            }
        }
        var f = "number" == typeof (n = n || 0);
        return s.left += f ? n : n.left || 0, s.top += f ? n : n.top || 0, s.right -= f ? n : n.right || 0, 
        s.bottom -= f ? n : n.bottom || 0, s;
    }
    function te(t, e, i, n, o, r) {
        ...
        }), h = 0 < u.length ? u[0].key : c[0].key, d = t.split("-")[1];
        return h + (d ? "-" + d : "");
    }
    function ee(t, e, n, i) {
        var o = 3 < arguments.length && void 0 !== i ? i : null;
        return Zt(n, o ? Gt(e) : qt(e, Lt(n)), o);
    }
    function ne(t) {
    ...
    function oe(t, e, n) {
        ...
        return o[s] = e[s] + e[l] / 2 - i[l] / 2, o[a] = n === a ? e[a] - i[c] : e[ie(a)], 
        o;
    }
    function re(t, e) {
    ...
    function se(t, n, e) {
        return (void 0 === e ? t : t.slice(0, function(t, e, n) {
            ...
            t.enabled && It(e) && (n.offsets.popper = Yt(n.offsets.popper), n.offsets.reference = Yt(n.offsets.reference), 
            n = e(n, t));
        }), n;
    }
    function ae(t, n) {
    ...
    function he() {
        ...
        e = this.state, ce(t).removeEventListener("resize", e.updateBound), e.scrollParents.forEach(function(t) {
    ...
    function fe(n, i) {
        Object.keys(i).forEach(function(t) {
            var e = "";
            -1 !== [ "width", "height", "top", "right", "bottom", "left" ].indexOf(t) && de(i[t]) && (e = "px"), 
            n.style[t] = i[t] + e;
        });
    }
    function pe(t, e) {
        ...
        var i = t.offsets, o = i.popper, r = i.reference, s = Math.round, a = Math.floor, l = s(r.width), c = s(o.width), u = -1 !== [ "left", "right" ].indexOf(t.placement), h = -1 !== t.placement.indexOf("-"), d = e ? u || h || l % 2 == c % 2 ? s : a : n, f = e ? s : n;
        return {
    ...
    var ge = kt && /Firefox/i.test(navigator.userAgent);
    function me(t, e, n) {
        var i = re(t, function(t) {
            return t.name === e;
    ...
    var ve = [ "auto-start", "auto", "auto-end", "top-start", "top", "top-end", "right-start", "right", "right-end", "bottom-end", "bottom", "bottom-start", "left-end", "left", "left-start" ], ye = ve.slice(3);
    function _e(t, e) {
        var n = 1 < arguments.length && void 0 !== e && e, i = ye.indexOf(t), o = ye.slice(i + 1).concat(ye.slice(0, i));
        return n ? o.reverse() : o;
    }
    var be = "flip", we = "clockwise", Ce = "counterclockwise";
    function xe(t, o, r, e) {
        var s = [ 0, 0 ], a = -1 !== [ "right", "left" ].indexOf(e), n = t.split(/(\+|\-)/).map(function(t) {
            return t.trim();
        }), i = n.indexOf(re(n, function(t) {
            return -1 !== t.search(/,|\s/);
        }));
    ...
    var Ee = {
        ...
        modifiers: {
            shift: {
                ...
                fn: function(t) {
                    ...
                    if (i) {
                        var o = t.offsets, r = o.reference, s = o.popper, a = -1 !== [ "bottom", "top" ].indexOf(n), l = a ? "left" : "top", c = a ? "width" : "height", u = {
                            start: Kt({}, l, r[l]),
                            end: Kt({}, l, r[l] + r[c] - s[c])
                        };
                        t.offsets.popper = Vt({}, s, u[i]);
                    }
                    return t;
                }
            },
            offset: {
                ...
                fn: function(t, e) {
                    ...
                    return l = de(+n) ? [ +n, 0 ] : xe(n, r, s, a), "left" === a ? (r.top += l[0], r.left -= l[1]) : "right" === a ? (r.top += l[0], 
            ...
            preventOverflow: {
                ...
                fn: function(t, i) {
                    ...
                    var n = le("transform"), o = t.instance.popper.style, r = o.top, s = o.left, a = o[n];
                    o.top = "", o.left = "", o[n] = "";
                    var l = Jt(t.instance.popper, t.instance.reference, i.padding, e, t.positionFixed);
                    o.top = r, o.left = s, o[n] = a, i.boundaries = l;
                    var c = i.priority, u = t.offsets.popper, h = {
                        primary: function(t) {
                            var e = u[t];
                            return u[t] < l[t] && !i.escapeWithReference && (e = Math.max(u[t], l[t])), Kt({}, t, e);
                        },
            ...
            arrow: {
                ...
                fn: function(t, e) {
                    ...
                    t;
                    var o = t.placement.split("-")[0], r = t.offsets, s = r.popper, a = r.reference, l = -1 !== [ "left", "right" ].indexOf(o), c = l ? "height" : "width", u = l ? "Top" : "Left", h = u.toLowerCase(), d = l ? "left" : "top", f = l ? "bottom" : "right", p = ne(i)[c];
                    a[f] - p < s[h] && (t.offsets.popper[h] -= s[h] - (a[f] - p)), a[h] + p > s[f] && (t.offsets.popper[h] += a[h] + p - s[f]), 
                    t.offsets.popper = Yt(t.offsets.popper);
                    var g = a[h] + a[c] / 2 - p / 2, m = Nt(t.instance.popper), v = parseFloat(m["margin" + u], 10), y = parseFloat(m["border" + u + "Width"], 10), _ = g - t.offsets.popper[h] - v - y;
                    return _ = Math.max(Math.min(s[c] - p, _), 0), t.arrowElement = i, t.offsets.arrow = (Kt(n = {}, h, Math.round(_)), 
                    Kt(n, d, ""), n), t;
                },
                element: "[x-arrow]"
            },
            flip: {
                ...
                enabled: !0,
                fn: function(m, v) {
                    if (ae(m.instance.modifiers, "inner")) return m;
                    if (m.flipped && m.placement === m.originalPlacement) return m;
                    var y = Jt(m.instance.popper, m.instance.reference, v.padding, v.boundariesElement, m.positionFixed), _ = m.placement.split("-")[0], b = ie(_), w = m.placement.split("-")[1] || "", C = [];
                    switch (v.behavior) {
                      case be:
                        C = [ _, b ];
                        break;
                    ...
                    return C.forEach(function(t, e) {
                        ...
                        _ = m.placement.split("-")[0], b = ie(_);
                        var n, i = m.offsets.popper, o = m.offsets.reference, r = Math.floor, s = "left" === _ && r(i.right) > r(o.left) || "right" === _ && r(i.left) < r(o.right) || "top" === _ && r(i.bottom) > r(o.top) || "bottom" === _ && r(i.top) < r(o.bottom), a = r(i.left) < r(y.left), l = r(i.right) > r(y.right), c = r(i.top) < r(y.top), u = r(i.bottom) > r(y.bottom), h = "left" === _ && a || "right" === _ && l || "top" === _ && c || "bottom" === _ && u, d = -1 !== [ "top", "bottom" ].indexOf(_), f = !!v.flipVariations && (d && "start" === w && a || d && "end" === w && l || !d && "start" === w && c || !d && "end" === w && u), p = !!v.flipVariationsByContent && (d && "start" === w && l || d && "end" === w && a || !d && "start" === w && u || !d && "end" === w && c), g = f || p;
                        (s || h || g) && (m.flipped = !0, (s || h) && (_ = C[e + 1]), g && (w = "end" === (n = w) ? "start" : "start" === n ? "end" : n), 
                        m.placement = _ + (w ? "-" + w : ""), m.offsets.popper = Vt({}, m.offsets.popper, oe(m.instance.popper, m.offsets.reference, m.placement)), 
            ...
            inner: {
                ...
                fn: function(t) {
                    ...
                    return o[s ? "left" : "top"] = r[n] - (a ? o[s ? "width" : "height"] : 0), t.placement = ie(e), 
                    t.offsets.popper = Yt(o), t;
                }
            },
            hide: {
                order: 800,
                ...
                fn: function(t) {
                    ...
                    var e = t.offsets.reference, n = re(t.instance.modifiers, function(t) {
            ...
            computeStyle: {
                ...
                enabled: !0,
                fn: function(t, e) {
                    var n = e.x, i = e.y, o = t.offsets.popper, r = re(t.instance.modifiers, function(t) {
                        return "applyStyle" === t.name;
                    }).gpuAcceleration;
                    void 0 !== r && console.warn("WARNING: `gpuAcceleration` option moved to `computeStyle` modifier and will not be supported in future versions of Popper.js!");
                    var s = void 0 !== r ? r : e.gpuAcceleration, a = $t(t.instance.popper), l = Xt(a), c = {
                        position: o.position
                    }, u = pe(t, window.devicePixelRatio < 2 || !ge), h = "bottom" === n ? "top" : "bottom", d = "right" === i ? "left" : "right", f = le("transform"), p = void 0, g = void 0;
                    if (g = "bottom" == h ? "HTML" === a.nodeName ? -a.clientHeight + u.bottom : -l.height + u.bottom : u.top, 
                    p = "right" == d ? "HTML" === a.nodeName ? -a.clientWidth + u.right : -l.width + u.right : u.left, 
                    s && f) c[f] = "translate3d(" + p + "px, " + g + "px, 0)", c[h] = 0, c[d] = 0, c.willChange = "transform"; else {
                    ...
                    return t.attributes = Vt({}, y, t.attributes), t.styles = Vt({}, c, t.styles), t.arrowStyles = Vt({}, t.offsets.arrow, t.arrowStyles), 
                    t;
                },
                gpuAcceleration: !0,
                x: "bottom",
            ...
            applyStyle: {
                ...
                fn: function(t) {
                    var e, n;
                    return fe(t.instance.popper, t.styles), e = t.instance.popper, n = t.attributes, 
                    Object.keys(n).forEach(function(t) {
                        !1 !== n[t] ? e.setAttribute(t, n[t]) : e.removeAttribute(t);
                    }), t.arrowElement && Object.keys(t.arrowStyles).length && fe(t.arrowElement, t.arrowStyles), 
                    t;
                },
                onLoad: function(t, e, n, i, o) {
                    var r = ee(o, e, t, n.positionFixed), s = te(n.placement, r, e, t, n.modifiers.flip.boundariesElement, n.modifiers.flip.padding);
                    return e.setAttribute("x-placement", s), fe(e, {
        ...
        value: function() {
            return function() {
                if (!this.state.isDestroyed) {
                    ...
                    t.offsets.reference = ee(this.state, this.popper, this.reference, this.options.positionFixed), 
                    t.placement = te(this.options.placement, t.offsets.reference, this.popper, this.reference, this.options.modifiers.flip.boundariesElement, this.options.modifiers.flip.padding), 
                    t.originalPlacement = t.placement, t.positionFixed = this.options.positionFixed, 
                    t.offsets.popper = oe(this.popper, t.offsets.reference, t.placement), t.offsets.popper.position = this.options.positionFixed ? "fixed" : "absolute", 
                    t = se(this.modifiers, t), this.state.isCreated ? this.options.onUpdate(t) : (this.state.isCreated = !0, 
        ...
        value: function() {
            return function() {
                return this.state.isDestroyed = !0, ae(this.modifiers, "applyStyle") && (this.popper.removeAttribute("x-placement"), 
                this.popper.style.position = "", this.popper.style.top = "", this.popper.style.left = "", 
                this.popper.style.right = "", this.popper.style.bottom = "", this.popper.style.willChange = "", 
                this.popper.style[le("transform")] = ""), this.disableEventListeners(), this.options.removeOnDestroy && this.popper.parentNode.removeChild(this.popper), 
                this;
            }.call(this);
        }
    }, {
    ...
    function Se(t, e) {
        ...
        }(this, Se), this.scheduleUpdate = function() {
            return requestAnimationFrame(n.update);
        }, this.update = Dt(this.update.bind(this)), this.options = Vt({}, Se.Defaults, i), 
        this.state = {
            isDestroyed: !1,
            isCreated: !1,
            scrollParents: []
        }, this.reference = t && t.jquery ? t[0] : t, this.popper = e && e.jquery ? e[0] : e, 
        this.options.modifiers = {}, Object.keys(Vt({}, Se.Defaults.modifiers, i.modifiers)).forEach(function(t) {
            n.options.modifiers[t] = Vt({}, Se.Defaults.modifiers[t] || {}, i.modifiers ? i.modifiers[t] : {});
    ...
    Te.Utils = ("undefined" != typeof window ? window : global).PopperUtils, Te.placements = ve, 
    Te.Defaults = Ee;
    var ke = "dropdown", Ae = "bs.dropdown", De = "." + Ae, Ie = ".data-api", Ne = p.fn[ke], Oe = new RegExp("38|40|27"), Pe = {
        HIDE: "hide" + De,
        HIDDEN: "hidden" + De,
        SHOW: "show" + De,
        SHOWN: "shown" + De,
    ...
    }, Le = "disabled", je = "show", Me = "dropup", He = "dropright", $e = "dropleft", ze = "dropdown-menu-right", qe = "position-static", Re = '[data-toggle="dropdown"]', We = ".dropdown form", Fe = ".dropdown-menu", Be = ".navbar-nav", Ue = ".dropdown-menu .dropdown-item:not(.disabled):not(:disabled)", Qe = "top-start", Ke = "top-end", Ve = "bottom-start", Ye = "bottom-end", Xe = "right-start", Ze = "left-start", Ge = {
        offset: 0,
        flip: !0,
        ...
        var t = c.prototype;
        return t.toggle = function() {
            if (!this._element.disabled && !p(this._element).hasClass(Le)) {
                var t = p(this._menu).hasClass(je);
                c._clearMenus(), t || this.show(!0);
            }
        }, t.show = function(t) {
            if (void 0 === t && (t = !1), !(this._element.disabled || p(this._element).hasClass(Le) || p(this._menu).hasClass(je))) {
                var e = {
                    relatedTarget: this._element
                }, n = p.Event(Pe.SHOW, e), i = c._getParentFromElement(this._element);
                if (p(i).trigger(n), !n.isDefaultPrevented()) {
                    if (!this._inNavbar && t) {
                        ...
                        void 0 !== this._config.reference.jquery && (o = this._config.reference[0])), "scrollParent" !== this._config.boundary && p(i).addClass(qe), 
                        this._popper = new Te(o, this._menu, this._getPopperConfig());
                    }
                    "ontouchstart" in document.documentElement && 0 === p(i).closest(Be).length && p(document.body).children().on("mouseover", null, p.noop), 
                    this._element.focus(), this._element.setAttribute("aria-expanded", !0), p(this._menu).toggleClass(je), 
                    p(i).toggleClass(je).trigger(p.Event(Pe.SHOWN, e));
                }
            }
        }, t.hide = function() {
            if (!this._element.disabled && !p(this._element).hasClass(Le) && p(this._menu).hasClass(je)) {
                var t = {
                    relatedTarget: this._element
                }, e = p.Event(Pe.HIDE, t), n = c._getParentFromElement(this._element);
                p(n).trigger(e), e.isDefaultPrevented() || (this._popper && this._popper.destroy(), 
                p(this._menu).toggleClass(je), p(n).toggleClass(je).trigger(p.Event(Pe.HIDDEN, t)));
            }
        }, t.dispose = function() {
            p.removeData(this._element, Ae), p(this._element).off(De), this._element = null, 
            (this._menu = null) !== this._popper && (this._popper.destroy(), this._popper = null);
        }, t.update = function() {
            this._inNavbar = this._detectNavbar(), null !== this._popper && this._popper.scheduleUpdate();
        }, t._addEventListeners = function() {
            var e = this;
            p(this._element).on(Pe.CLICK, function(t) {
                t.preventDefault(), t.stopPropagation(), e.toggle();
            });
        }, t._getConfig = function(t) {
            return t = l({}, this.constructor.Default, {}, p(this._element).data(), {}, t), 
            g.typeCheckConfig(ke, t, this.constructor.DefaultType), t;
            ...
            var t = p(this._element.parentNode), e = Ve;
            return t.hasClass(Me) ? (e = Qe, p(this._menu).hasClass(ze) && (e = Ke)) : t.hasClass(He) ? e = Xe : t.hasClass($e) ? e = Ze : p(this._menu).hasClass(ze) && (e = Ye), 
            e;
            ...
            return this.each(function() {
                var t = p(this).data(Ae);
                if (t || (t = new c(this, "object" == typeof e ? e : null), p(this).data(Ae, t)), 
                "string" == typeof e) {
            ...
            if (!t || 3 !== t.which && ("keyup" !== t.type || 9 === t.which)) for (var e = [].slice.call(document.querySelectorAll(Re)), n = 0, i = e.length; n < i; n++) {
                var o = c._getParentFromElement(e[n]), r = p(e[n]).data(Ae), s = {
                    relatedTarget: e[n]
                };
                if (t && "click" === t.type && (s.clickEvent = t), r) {
                    var a = r._menu;
                    if (p(o).hasClass(je) && !(t && ("click" === t.type && /input|textarea/i.test(t.target.tagName) || "keyup" === t.type && 9 === t.which) && p.contains(o, t.target))) {
                        var l = p.Event(Pe.HIDE, s);
                        ...
                        e[n].setAttribute("aria-expanded", "false"), r._popper && r._popper.destroy(), p(a).removeClass(je), 
                        p(o).removeClass(je).trigger(p.Event(Pe.HIDDEN, s)));
                    }
                }
            }
            ...
            if ((/input|textarea/i.test(t.target.tagName) ? !(32 === t.which || 27 !== t.which && (40 !== t.which && 38 !== t.which || p(t.target).closest(Fe).length)) : Oe.test(t.which)) && (t.preventDefault(), 
            t.stopPropagation(), !this.disabled && !p(this).hasClass(Le))) {
                var e = c._getParentFromElement(this), n = p(e).hasClass(je);
                if (n || 27 !== t.which) if (n && (!n || 27 !== t.which && 32 !== t.which)) {
                    var i = [].slice.call(e.querySelectorAll(Ue)).filter(function(t) {
    ...
    p(document).on(Pe.KEYDOWN_DATA_API, Re, tn._dataApiKeydownHandler).on(Pe.KEYDOWN_DATA_API, Fe, tn._dataApiKeydownHandler).on(Pe.CLICK_DATA_API + " " + Pe.KEYUP_DATA_API, tn._clearMenus).on(Pe.CLICK_DATA_API, Re, function(t) {
        t.preventDefault(), t.stopPropagation(), tn._jQueryInterface.call(p(this), "toggle");
    }).on(Pe.CLICK_DATA_API, We, function(t) {
        t.stopPropagation();
    }), p.fn[ke] = tn._jQueryInterface, p.fn[ke].Constructor = tn, p.fn[ke].noConflict = function() {
        return p.fn[ke] = Ne, tn._jQueryInterface;
    };
    var en = "modal", nn = "bs.modal", on = "." + nn, rn = p.fn[en], sn = {
        backdrop: !0,
        keyboard: !0,
        focus: !0,
        show: !0
    ...
    }, cn = "modal-dialog-scrollable", un = "modal-scrollbar-measure", hn = "modal-backdrop", dn = "modal-open", fn = "fade", pn = "show", gn = "modal-static", mn = ".modal-dialog", vn = ".modal-body", yn = '[data-toggle="modal"]', _n = '[data-dismiss="modal"]', bn = ".fixed-top, .fixed-bottom, .is-fixed, .sticky-top", wn = ".sticky-top", Cn = function() {
        function o(t, e) {
            this._config = this._getConfig(e), this._element = t, this._dialog = t.querySelector(mn), 
        ...
        return t.toggle = function(t) {
            ...
            if (!this._isShown && !this._isTransitioning) {
                p(this._element).hasClass(fn) && (this._isTransitioning = !0);
                ...
                this._setResizeEvent(), p(this._element).on(ln.CLICK_DISMISS, _n, function(t) {
                    return e.hide(t);
                }), p(this._dialog).on(ln.MOUSEDOWN_DISMISS, function() {
                    p(e._element).one(ln.MOUSEUP_DISMISS, function(t) {
            ...
            if (t && t.preventDefault(), this._isShown && !this._isTransitioning) {
                ...
                if (p(this._element).trigger(n), this._isShown && !n.isDefaultPrevented()) {
                    this._isShown = !1;
                    var i = p(this._element).hasClass(fn);
                    if (i && (this._isTransitioning = !0), this._setEscapeEvent(), this._setResizeEvent(), 
                    p(document).off(ln.FOCUSIN), p(this._element).removeClass(pn), p(this._element).off(ln.CLICK_DISMISS), 
                    p(this._dialog).off(ln.MOUSEDOWN_DISMISS), i) {
            ...
            [ window, this._element, this._dialog ].forEach(function(t) {
                return p(t).off(on);
            }), p(document).off(ln.FOCUSIN), p.removeData(this._element, nn), this._config = null, 
            ...
            return t = l({}, sn, {}, t), g.typeCheckConfig(en, t, an), t;
        }, t._triggerBackdropTransition = function() {
            var t = this;
            if ("static" === this._config.backdrop) {
                var e = p.Event(ln.HIDE_PREVENTED);
            ...
            var e = this, n = p(this._element).hasClass(fn), i = this._dialog ? this._dialog.querySelector(vn) : null;
            this._element.parentNode && this._element.parentNode.nodeType === Node.ELEMENT_NODE || document.body.appendChild(this._element), 
            this._element.style.display = "block", this._element.removeAttribute("aria-hidden"), 
            this._element.setAttribute("aria-modal", !0), p(this._dialog).hasClass(cn) && i ? i.scrollTop = 0 : this._element.scrollTop = 0, 
            n && g.reflow(this._element), p(this._element).addClass(pn), this._config.focus && this._enforceFocus();
            function o() {
                e._config.focus && e._element.focus(), e._isTransitioning = !1, p(e._element).trigger(r);
            }
            ...
            var e = this;
            p(document).off(ln.FOCUSIN).on(ln.FOCUSIN, function(t) {
                document !== t.target && e._element !== t.target && 0 === p(e._element).has(t.target).length && e._element.focus();
            });
        }, t._setEscapeEvent = function() {
            var e = this;
            this._isShown && this._config.keyboard ? p(this._element).on(ln.KEYDOWN_DISMISS, function(t) {
                27 === t.which && e._triggerBackdropTransition();
            }) : this._isShown || p(this._element).off(ln.KEYDOWN_DISMISS);
        }, t._setResizeEvent = function() {
            var e = this;
            this._isShown ? p(window).on(ln.RESIZE, function(t) {
            ...
            this._element.removeAttribute("aria-modal"), this._isTransitioning = !1, this._showBackdrop(function() {
                p(document.body).removeClass(dn), t._resetAdjustments(), t._resetScrollbar(), p(t._element).trigger(ln.HIDDEN);
            });
        }, t._removeBackdrop = function() {
            this._backdrop && (p(this._backdrop).remove(), this._backdrop = null);
        }, t._showBackdrop = function(t) {
            var e = this, n = p(this._element).hasClass(fn) ? fn : "";
            if (this._isShown && this._config.backdrop) {
                if (this._backdrop = document.createElement("div"), this._backdrop.className = hn, 
                n && this._backdrop.classList.add(n), p(this._backdrop).appendTo(document.body), 
                p(this._element).on(ln.CLICK_DISMISS, function(t) {
                    e._ignoreBackdropClick ? e._ignoreBackdropClick = !1 : t.target === t.currentTarget && e._triggerBackdropTransition();
                }), n && g.reflow(this._backdrop), p(this._backdrop).addClass(pn), !t) return;
                if (!n) return void t();
                ...
                if (p(this._element).hasClass(fn)) {
            ...
            if (this._isBodyOverflowing) {
                var t = [].slice.call(document.querySelectorAll(bn)), e = [].slice.call(document.querySelectorAll(wn));
            ...
            var t = document.createElement("div");
            t.className = un, document.body.appendChild(t);
            var e = t.getBoundingClientRect().width - t.clientWidth;
            return document.body.removeChild(t), e;
        }, o._jQueryInterface = function(n, i) {
            return this.each(function() {
                var t = p(this).data(nn), e = l({}, sn, {}, p(this).data(), {}, "object" == typeof n && n ? n : {});
                if (t || (t = new o(this, e), p(this).data(nn, t)), "string" == typeof n) {
                    if (void 0 === t[n]) throw new TypeError('No method named "' + n + '"');
                    t[n](i);
    ...
    p(document).on(ln.CLICK_DATA_API, yn, function(t) {
        var e, n = this, i = g.getSelectorFromElement(this);
        i && (e = document.querySelector(i));
        var o = p(e).data(nn) ? "toggle" : l({}, p(e).data(), {}, p(this).data());
        "A" !== this.tagName && "AREA" !== this.tagName || t.preventDefault();
        var r = p(e).one(ln.SHOW, function(t) {
            t.isDefaultPrevented() || r.one(ln.HIDDEN, function() {
                p(n).is(":visible") && n.focus();
            });
        });
        Cn._jQueryInterface.call(p(e), o, this);
    }), p.fn[en] = Cn._jQueryInterface, p.fn[en].Constructor = Cn, p.fn[en].noConflict = function() {
        return p.fn[en] = rn, Cn._jQueryInterface;
    };
    var xn = [ "background", "cite", "href", "itemtype", "longdesc", "poster", "src", "xlink:href" ], En = {
        ...
        u: [],
        ul: []
    }, Tn = /^(?:(?:https?|mailto|ftp|tel|file):|[^&:/?#]*(?:[/?#]|$))/gi, Sn = /^data:(?:image\/(?:bmp|gif|jpeg|jpg|png|tiff|webp)|video\/(?:mpeg|mp4|ogg|webm)|audio\/(?:mp3|oga|ogg|opus));base64,[a-z0-9+/]+=*$/i;
    function kn(t, r, e) {
        ...
        for (var n = new window.DOMParser().parseFromString(t, "text/html"), s = Object.keys(r), a = [].slice.call(n.body.querySelectorAll("*")), i = function(t) {
            ...
            i.forEach(function(t) {
                !function(t, e) {
                    ...
                    if (-1 !== e.indexOf(n)) return -1 === xn.indexOf(n) || Boolean(t.nodeValue.match(Tn) || t.nodeValue.match(Sn));
    ...
    var An = "tooltip", Dn = "bs.tooltip", In = "." + Dn, Nn = p.fn[An], On = "bs-tooltip", Pn = new RegExp("(^|\\s)" + On + "\\S+", "g"), Ln = [ "sanitize", "whiteList", "sanitizeFn" ], jn = {
        animation: "boolean",
        template: "string",
    ...
    }, Rn = "fade", Wn = "show", Fn = ".tooltip-inner", Bn = ".arrow", Un = "hover", Qn = "focus", Kn = "click", Vn = "manual", Yn = function() {
        function i(t, e) {
        ...
        return t.enable = function() {
            ...
            if (this.isWithContent() && this._isEnabled) {
                ...
                p(this.element).trigger(this.constructor.Event.INSERTED), this._popper = new Te(this.element, o, this._getPopperConfig(a)), 
                p(o).addClass(Wn), "ontouchstart" in document.documentElement && p(document.body).children().on("mouseover", null, p.noop);
                var c = function() {
            ...
            function e() {
                n._hoverState !== $n && i.parentNode && i.parentNode.removeChild(i), n._cleanTipClass(), 
            ...
            if (p(this.element).trigger(o), !o.isDefaultPrevented()) {
                if (p(i).removeClass(Wn), "ontouchstart" in document.documentElement && p(document.body).children().off("mouseover", null, p.noop), 
                this._activeTrigger[Kn] = !1, this._activeTrigger[Qn] = !1, this._activeTrigger[Un] = !1, 
            ...
            this.setElementContent(p(t.querySelectorAll(Fn)), this.getTitle()), p(t).removeClass(Rn + " " + Wn);
        }, t.setElementContent = function(t, e) {
            "object" != typeof e || !e.nodeType && !e.jquery ? this.config.html ? (this.config.sanitize && (e = kn(e, this.config.whiteList, this.config.sanitizeFn)), 
            ...
            this.config.trigger.split(" ").forEach(function(t) {
                if ("click" === t) p(i.element).on(i.constructor.Event.CLICK, i.config.selector, function(t) {
                    ...
                    var e = t === Un ? i.constructor.Event.MOUSEENTER : i.constructor.Event.FOCUSIN, n = t === Un ? i.constructor.Event.MOUSELEAVE : i.constructor.Event.FOCUSOUT;
            ...
            p(t.currentTarget).data(n, e)), t && (e._activeTrigger["focusin" === t.type ? Qn : Un] = !0), 
            p(e.getTipElement()).hasClass(Wn) || e._hoverState === $n ? e._hoverState = $n : (clearTimeout(e._timeout), 
            e._hoverState = $n, e.config.delay && e.config.delay.show ? e._timeout = setTimeout(function() {
                e._hoverState === $n && e.show();
            }, e.config.delay.show) : e.show());
        }, t._leave = function(t, e) {
            var n = this.constructor.DATA_KEY;
            (e = e || p(t.currentTarget).data(n)) || (e = new this.constructor(t.currentTarget, this._getDelegateConfig()), 
            p(t.currentTarget).data(n, e)), t && (e._activeTrigger["focusout" === t.type ? Qn : Un] = !1), 
            e._isWithActiveTrigger() || (clearTimeout(e._timeout), e._hoverState = zn, e.config.delay && e.config.delay.hide ? e._timeout = setTimeout(function() {
            ...
            return Object.keys(e).forEach(function(t) {
                -1 !== Ln.indexOf(t) && delete e[t];
            }), "number" == typeof (t = l({}, this.constructor.Default, {}, e, {}, "object" == typeof t && t ? t : {})).delay && (t.delay = {
                show: t.delay,
                hide: t.delay
            }), "number" == typeof t.title && (t.title = t.title.toString()), "number" == typeof t.content && (t.content = t.content.toString()), 
            g.typeCheckConfig(An, t, this.constructor.DefaultType), t.sanitize && (t.template = kn(t.template, t.whiteList, t.sanitizeFn)), 
            t;
            ...
            var t = p(this.getTipElement()), e = t.attr("class").match(Pn);
            ...
            null === t.getAttribute("x-placement") && (p(t).removeClass(Rn), this.config.animation = !1, 
            this.hide(), this.show(), this.config.animation = e);
        }, i._jQueryInterface = function(n) {
            return this.each(function() {
                var t = p(this).data(Dn), e = "object" == typeof n && n;
                if ((t || !/dispose|hide/.test(n)) && (t || (t = new i(this, e), p(this).data(Dn, t)), 
                "string" == typeof n)) {
                    if (void 0 === t[n]) throw new TypeError('No method named "' + n + '"');
                    t[n]();
                }
    ...
    p.fn[An] = Yn._jQueryInterface, p.fn[An].Constructor = Yn, p.fn[An].noConflict = function() {
        return p.fn[An] = Nn, Yn._jQueryInterface;
    };
    var Xn = "popover", Zn = "bs.popover", Gn = "." + Zn, Jn = p.fn[Xn], ti = "bs-popover", ei = new RegExp("(^|\\s)" + ti + "\\S+", "g"), ni = l({}, Yn.Default, {
        placement: "right",
        trigger: "click",
        content: "",
    ...
    }), oi = "fade", ri = "show", si = ".popover-header", ai = ".popover-body", li = {
        HIDE: "hide" + Gn,
        HIDDEN: "hidden" + Gn,
        SHOW: "show" + Gn,
        SHOWN: "shown" + Gn,
        ...
        return o.isWithContent = function() {
            ...
            p(this.getTipElement()).addClass(ti + "-" + t);
            ...
            "function" == typeof e && (e = e.call(this.element)), this.setElementContent(t.find(ai), e), 
            t.removeClass(oi + " " + ri);
        }, o._getContent = function() {
            return this.element.getAttribute("data-content") || this.config.content;
        }, o._cleanTipClass = function() {
            var t = p(this.getTipElement()), e = t.attr("class").match(ei);
            null !== e && 0 < e.length && t.removeClass(e.join(""));
        }, i._jQueryInterface = function(n) {
            return this.each(function() {
                var t = p(this).data(Zn), e = "object" == typeof n ? n : null;
                if ((t || !/dispose|hide/.test(n)) && (t || (t = new i(this, e), p(this).data(Zn, t)), 
                "string" == typeof n)) {
                    if (void 0 === t[n]) throw new TypeError('No method named "' + n + '"');
                    t[n]();
                }
    ...
    p.fn[Xn] = ci._jQueryInterface, p.fn[Xn].Constructor = ci, p.fn[Xn].noConflict = function() {
        return p.fn[Xn] = Jn, ci._jQueryInterface;
    };
    var ui = "scrollspy", hi = "bs.scrollspy", di = "." + hi, fi = p.fn[ui], pi = {
        offset: 10,
        method: "auto",
        target: ""
    }, gi = {
    ...
    }, vi = "dropdown-item", yi = "active", _i = '[data-spy="scroll"]', bi = ".nav, .list-group", wi = ".nav-link", Ci = ".nav-item", xi = ".list-group-item", Ei = ".dropdown", Ti = ".dropdown-item", Si = ".dropdown-toggle", ki = "offset", Ai = "position", Di = function() {
        function n(t, e) {
            var n = this;
            this._element = t, this._scrollElement = "BODY" === t.tagName ? window : t, this._config = this._getConfig(e), 
            this._selector = this._config.target + " " + wi + "," + this._config.target + " " + xi + "," + this._config.target + " " + Ti, 
            this._offsets = [], this._targets = [], this._activeTarget = null, this._scrollHeight = 0, 
            p(this._scrollElement).on(mi.SCROLL, function(t) {
                return n._process(t);
            }), this.refresh(), this._process();
        }
        var t = n.prototype;
        return t.refresh = function() {
            var e = this, t = this._scrollElement === this._scrollElement.window ? ki : Ai, o = "auto" === this._config.method ? t : this._config.method, r = o === Ai ? this._getScrollTop() : 0;
            ...
            p.removeData(this._element, hi), p(this._scrollElement).off(di), this._element = null, 
            ...
            if ("string" != typeof (t = l({}, pi, {}, "object" == typeof t && t ? t : {})).target) {
                var e = p(t.target).attr("id");
                e || (e = g.getUID(ui), p(t.target).attr("id", e)), t.target = "#" + e;
            }
            return g.typeCheckConfig(ui, t, gi), t;
            ...
            n.hasClass(vi) ? (n.closest(Ei).find(Si).addClass(yi), n.addClass(yi)) : (n.addClass(yi), 
            n.parents(bi).prev(wi + ", " + xi).addClass(yi), n.parents(bi).prev(Ci).children(wi).addClass(yi)), 
            p(this._scrollElement).trigger(mi.ACTIVATE, {
                relatedTarget: e
            });
        }, t._clear = function() {
            [].slice.call(document.querySelectorAll(this._selector)).filter(function(t) {
                ...
                return t.classList.remove(yi);
            });
        }, n._jQueryInterface = function(e) {
            return this.each(function() {
                var t = p(this).data(hi);
                if (t || (t = new n(this, "object" == typeof e && e), p(this).data(hi, t)), "string" == typeof e) {
                    if (void 0 === t[e]) throw new TypeError('No method named "' + e + '"');
                    t[e]();
                }
            });
    ...
    p(window).on(mi.LOAD_DATA_API, function() {
        for (var t = [].slice.call(document.querySelectorAll(_i)), e = t.length; e--; ) {
            var n = p(t[e]);
            Di._jQueryInterface.call(n, n.data());
        }
    }), p.fn[ui] = Di._jQueryInterface, p.fn[ui].Constructor = Di, p.fn[ui].noConflict = function() {
        return p.fn[ui] = fi, Di._jQueryInterface;
    };
    var Ii = "bs.tab", Ni = "." + Ii, Oi = p.fn.tab, Pi = {
        HIDE: "hide" + Ni,
        HIDDEN: "hidden" + Ni,
        SHOW: "show" + Ni,
        SHOWN: "shown" + Ni,
        CLICK_DATA_API: "click" + Ni + ".data-api"
    }, Li = "dropdown-menu", ji = "active", Mi = "disabled", Hi = "fade", $i = "show", zi = ".dropdown", qi = ".nav, .list-group", Ri = ".active", Wi = "> li > .active", Fi = '[data-toggle="tab"], [data-toggle="pill"], [data-toggle="list"]', Bi = ".dropdown-toggle", Ui = "> .dropdown-menu .active", Qi = function() {
        function i(t) {
            this._element = t;
        }
        var t = i.prototype;
        return t.show = function() {
            var n = this;
            if (!(this._element.parentNode && this._element.parentNode.nodeType === Node.ELEMENT_NODE && p(this._element).hasClass(ji) || p(this._element).hasClass(Mi))) {
                var t, i, e = p(this._element).closest(qi)[0], o = g.getSelectorFromElement(this._element);
                if (e) {
                    var r = "UL" === e.nodeName || "OL" === e.nodeName ? Wi : Ri;
            ...
            p.removeData(this._element, Ii), this._element = null;
        }, t._activate = function(t, e, n) {
            function i() {
                return o._transitionComplete(t, r, n);
            }
            var o = this, r = (!e || "UL" !== e.nodeName && "OL" !== e.nodeName ? p(e).children(Ri) : p(e).find(Wi))[0], s = n && r && p(r).hasClass(Hi);
            if (r && s) {
                var a = g.getTransitionDurationFromElement(r);
                p(r).removeClass($i).one(g.TRANSITION_END, i).emulateTransitionEnd(a);
            } else i();
        }, t._transitionComplete = function(t, e, n) {
            if (e) {
                p(e).removeClass(ji);
                var i = p(e.parentNode).find(Ui)[0];
                i && p(i).removeClass(ji), "tab" === e.getAttribute("role") && e.setAttribute("aria-selected", !1);
            }
            if (p(t).addClass(ji), "tab" === t.getAttribute("role") && t.setAttribute("aria-selected", !0), 
            g.reflow(t), t.classList.contains(Hi) && t.classList.add($i), t.parentNode && p(t.parentNode).hasClass(Li)) {
                var o = p(t).closest(zi)[0];
                if (o) {
                    var r = [].slice.call(o.querySelectorAll(Bi));
                    p(r).addClass(ji);
                }
    ...
    p(document).on(Pi.CLICK_DATA_API, Fi, function(t) {
        t.preventDefault(), Qi._jQueryInterface.call(p(this), "show");
    }), p.fn.tab = Qi._jQueryInterface, p.fn.tab.Constructor = Qi, p.fn.tab.noConflict = function() {
        return p.fn.tab = Oi, Qi._jQueryInterface;
    };
    var Ki = "toast", Vi = "bs.toast", Yi = "." + Vi, Xi = p.fn[Ki], Zi = {
        CLICK_DISMISS: "click.dismiss" + Yi,
        HIDE: "hide" + Yi,
        HIDDEN: "hidden" + Yi,
        SHOW: "show" + Yi,
        SHOWN: "shown" + Yi
    }, Gi = "fade", Ji = "hide", to = "show", eo = "showing", no = {
        animation: "boolean",
        autohide: "boolean",
        delay: "number"
    }, io = {
        ...
        autohide: !0,
        delay: 500
    }, oo = '[data-dismiss="toast"]', ro = function() {
        function i(t, e) {
            this._element = t, this._config = this._getConfig(e), this._timeout = null, this._setListeners();
        }
        var t = i.prototype;
        return t.show = function() {
            var t = this, e = p.Event(Zi.SHOW);
            if (p(this._element).trigger(e), !e.isDefaultPrevented()) {
                this._config.animation && this._element.classList.add(Gi);
                var n = function() {
                    t._element.classList.remove(eo), t._element.classList.add(to), p(t._element).trigger(Zi.SHOWN), 
                    t._config.autohide && (t._timeout = setTimeout(function() {
                        t.hide();
                    }, t._config.delay));
                };
                if (this._element.classList.remove(Ji), g.reflow(this._element), this._element.classList.add(eo), 
            ...
            if (this._element.classList.contains(to)) {
                var t = p.Event(Zi.HIDE);
                p(this._element).trigger(t), t.isDefaultPrevented() || this._close();
            }
        }, t.dispose = function() {
            clearTimeout(this._timeout), this._timeout = null, this._element.classList.contains(to) && this._element.classList.remove(to), 
            p(this._element).off(Zi.CLICK_DISMISS), p.removeData(this._element, Vi), this._element = null, 
            this._config = null;
        }, t._getConfig = function(t) {
            return t = l({}, io, {}, p(this._element).data(), {}, "object" == typeof t && t ? t : {}), 
            g.typeCheckConfig(Ki, t, this.constructor.DefaultType), t;
        }, t._setListeners = function() {
            var t = this;
            p(this._element).on(Zi.CLICK_DISMISS, oo, function() {
                return t.hide();
            });
        }, t._close = function() {
            function t() {
                e._element.classList.add(Ji), p(e._element).trigger(Zi.HIDDEN);
            }
            var e = this;
            if (this._element.classList.remove(to), this._config.animation) {
                var n = g.getTransitionDurationFromElement(this._element);
                p(this._element).one(g.TRANSITION_END, t).emulateTransitionEnd(n);
            } else t();
        }, i._jQueryInterface = function(n) {
            return this.each(function() {
                var t = p(this), e = t.data(Vi);
                if (e || (e = new i(this, "object" == typeof n && n), t.data(Vi, e)), "string" == typeof n) {
                    if (void 0 === e[n]) throw new TypeError('No method named "' + n + '"');
                    e[n](this);
                }
            });
    ...
    p.fn[Ki] = ro._jQueryInterface, p.fn[Ki].Constructor = ro, p.fn[Ki].noConflict = function() {
        return p.fn[Ki] = Xi, ro._jQueryInterface;
    }, t.Alert = v, t.Button = L, t.Carousel = ut, t.Collapse = St, t.Dropdown = tn, 
    t.Modal = Cn, t.Popover = ci, t.Scrollspy = Di, t.Tab = Qi, t.Toast = ro, t.Tooltip = Yn, 
    t.Util = g, Object.defineProperty(t, "__esModule", {
        value: !0
    });
}), function(t) {
    "function" == typeof define && define.amd ? define([ "jquery" ], t) : "object" == typeof exports ? t(require("jquery")) : t(jQuery);
}(function(r, i) {
    var n = "plugin_hideShowPassword", o = [ "show", "innerToggle" ], e = {
        show: "infer",
        innerToggle: !1,
        enable: function() {
            var t = document.body, e = document.createElement("input"), n = !0;
    ...
    s.prototype = {
        init: function(t) {
            this.update(t, e) && (this.element.addClass(this.options.className), this.options.innerToggle && (this.wrapElement(this.options.wrapper), 
            this.initToggle(this.options.toggle), "string" == typeof this.options.innerToggle && (this.toggleElement.hide(), 
            this.element.one(this.options.innerToggle, r.proxy(function() {
                this.toggleElement.show();
            }, this)))), this.element.trigger(this.options.initEvent, [ this ]));
        },
        update: function(t, e) {
            return this.options = this.prepareOptions(t, e), this.updateElement() && this.element.trigger(this.options.changeEvent, [ this ]).trigger(this.state().changeEvent, [ this ]), 
            this.options.enable;
        },
        toggle: function(t) {
        ...
        prepareOptions: function(t, e) {
            var n, i = t || {}, o = [];
            if (e = e || this.options, t = r.extend(!0, {}, e, t), i.hasOwnProperty("wrapper") && i.wrapper.hasOwnProperty("inheritStyles") && (t.wrapper.inheritStyles = i.wrapper.inheritStyles), 
            t.enable && ("toggle" === t.show ? t.show = this.isType("hidden", t.states) : "infer" === t.show && (t.show = this.isType("shown", t.states)), 
            "infer" === t.toggle.position && (t.toggle.position = "rtl" === this.element.css("text-direction") ? "left" : "right"), 
            !r.isArray(t.toggle.attachToKeyCodes))) {
        ...
        updateElement: function() {
            return !(!this.options.enable || this.isType()) && (this.element.prop(r.extend({}, this.options.props, this.state().props)).addClass(this.state().className).removeClass(this.otherState().className), 
            this.options.triggerOnToggle && this.element.trigger(this.options.triggerOnToggle, [ this ]), 
            this.updateToggle(), !0);
        },
        isType: function(t, e) {
            return (e = e || this.options.states)[t = t || this.state(i, i, e).props.type] && (t = e[t].props.type), 
            this.element.prop("type") === t;
        },
        state: function(t, e, n) {
            return n = n || this.options.states, t === i && (t = this.options.show), "boolean" == typeof t && (t = t ? "shown" : "hidden"), 
            e && (t = "shown" === t ? "hidden" : "shown"), n[t];
        },
        otherState: function(t) {
            return this.state(t, !0);
        },
        wrapElement: function(n) {
            var t, e = n.enforceWidth;
            ...
            }, this)), this.element.css(n.innerElementStyles).wrap(r(n.element).addClass(n.className).css(n.styles)), 
            this.wrapperElement = this.element.parent(), !0 === e && (e = this.wrapperElement.outerWidth() !== t && t), 
            !1 !== e && this.wrapperElement.css("width", e)), this.wrapperElement;
        },
        initToggle: function(t) {
            return this.toggleElement.length || (this.toggleElement = r(t.element).attr(t.attr).addClass(t.className).css(t.styles).appendTo(this.wrapperElement), 
            this.updateToggle(), this.positionToggle(t.position, t.verticalAlign, t.offset), 
            t.touchSupport ? (this.toggleElement.css(t.touchStyles), this.element.on(t.attachToTouchEvent, r.proxy(this.toggleTouchEvent, this))) : this.toggleElement.on(t.attachToEvent, r.proxy(this.toggleEvent, this)), 
            t.attachToKeyCodes.length && this.toggleElement.on(t.attachToKeyEvent, r.proxy(this.toggleKeyEvent, this))), 
            this.toggleElement;
        },
        ...
        updateToggle: function(t, e) {
            ...
            t = t || this.state().toggle, e = e || this.otherState().toggle, this.toggleElement.attr(t.attr).addClass(t.className).removeClass(e.className).html(t.content), 
            i = this.toggleElement.outerWidth() + 2 * this.options.toggle.offset, this.element.css(n) !== i && this.element.css(n, i)), 
            this.toggleElement;
        },
        ...
        toggleTouchEvent: function(t) {
            var e, n, i, o = this.toggleElement.offset().left;
            o && (e = t.pageX || t.originalEvent.pageX, i = "left" === this.options.toggle.position ? (n = e, 
            o += this.toggleElement.outerWidth()) : (n = o, e), n <= i && this.toggleEvent(t));
        }
    ...
    r.fn.niceSelect = function(t) {
        if ("string" == typeof t) return "update" == t ? this.each(function() {
            var t = r(this), e = r(this).next(".nice-select"), n = e.hasClass("open");
            e.length && (e.remove(), i(t), n && t.next().trigger("click"));
        }) : "destroy" == t ? (this.each(function() {
            var t = r(this), e = r(this).next(".nice-select");
            e.length && (e.remove(), t.css("display", ""));
        }), 0 == r(".nice-select").length && r(document).off(".nice_select")) : console.log('Method "' + t + '" does not exist.'), 
        this;
        function i(t) {
            ...
            var i = t.next(), e = t.find("option"), n = t.find("option:selected");
            i.find(".current").html(n.data("display") || n.text()), e.each(function(t) {
                var e = r(this), n = e.data("display");
        ...
        this.hide(), this.each(function() {
            ...
            var e = r(this);
            r(".nice-select").not(e).removeClass("open"), e.toggleClass("open"), e.hasClass("open") ? (e.find(".option"), 
            e.find(".focus").removeClass("focus"), e.find(".selected").addClass("focus")) : e.focus();
            ...
            var e = r(this), n = e.closest(".nice-select");
            ...
            var e = r(this), n = r(e.find(".focus") || e.find(".list .option.selected"));
            if (32 == t.keyCode || 13 == t.keyCode) return e.hasClass("open") ? n.trigger("click") : e.trigger("click"), 
            !1;
            if (40 == t.keyCode) {
                if (e.hasClass("open")) {
                    var i = n.nextAll(".option:not(.disabled)").first();
                    0 < i.length && (e.find(".focus").removeClass("focus"), i.addClass("focus"));
        ...
        return e.cssText = "pointer-events:auto", "auto" !== e.pointerEvents && r("html").addClass("no-csspointerevents"), 
        this;
    };
}(jQuery);