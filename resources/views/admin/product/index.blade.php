...
<div class="row">
  <div class="col-12 text-right py-2">
      ...
      <form class="d-inline" action="{{route('admin.product.download')}}" method="POST">
        @csrf
        <button data-toggle="tooltip" data-placement="top" title="Donwload Products Data" class="btn btn-success"><i class="fa fa-download" aria-hidden="true"></i></button>
      </form>
		...
		@foreach($products as $product)
         ...
         <tr  align="center"   data-toggle="tooltip" data-placement="top"
          ...
          >
           ...
           <td class="font-pt font-18">{{substr($product->name,0,20)}}</td>
