...
<div class="row">
  ...
  <div class="col-12 col-lg-6">
    <div class="card p-3">
      ...
      <h3 class="text-center font-pt font-20">Reply</h3>
      <hr class="mb-2">


      {{-- <label for="email">Email*</label> --}}
      <input type="hidden" name="email" value="{{$email->email}}" class="form-control mb-2" id="send_email"> 

      {{-- <label for="subject">Subject*</label> --}}
      <input type="hidden" name="subject" value="{{$email->subject}}" class="form-control mb-2" id="subject">
