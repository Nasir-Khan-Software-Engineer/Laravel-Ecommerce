	...
	<div class="row">
		...
		<div class="col-12 col-lg-10 col-xl-8 offset-lg-1 offset-lx-2" id="section-to-print">
			...
			<div class="heder-area p-2 mt-4">
				...
				<div class="order-to-area text-center
				...
				<table class="table table-bordered">
					...
					<tbody>
						...
						<tr>
							...
							<td ><b>{{$order->shipping_cost}} Tk</b></td>
						</tr>

						<tr>
							<td colspan="5"><b>Coupon ({{$coupon->code}}) / Discount</b></td>
							<td ><b>{{$coupon->discount}} Tk</b></td>
						</tr>

						<tr>
							@php
								$grand_total = ($total + $order->shipping_cost) - $coupon->discount;
							@endphp
			...
			<div class="signature">
				...
				<h5 class="text-right mt-5" style="border-top: 1px solid black; display: inline-block; float: right; padding: 2px 30px">{{$settings->title}}</h5>
			</div>
