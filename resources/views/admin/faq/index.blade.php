       ...
       <tbody>
        ...
        <tr align="center">
         ...
         <td class="font-pt font-18">
           ...
           <button data-question="{{$faq->question}}" data-id="{{$faq->id}}" data-ans="{{$faq->ans}}"  class="btn btn-primary faq-edit-btn" type="button" data-toggle="modal" data-target="#faq-edit-modal"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></button>
