...
<div class="row mt-2">
	<div class="col-12 col-lg-4">
		<div class="card p-3">
			<h1 class="text-center font-pt font-25">{{$offer->name}} | 
				@if($offer->active) 
			...
			<h5 class="text-center font-pt font-18 mt-1"><b>Added By: </b>{{$offer->user->name}}</h5>
			<h5 class="text-center font-pt font-18"><b>Date: </b>{{$offer->created_at->format('d-m-Y')}}</h5>
			<hr>
			...
			<p><b>End Time: </b>{{$offer->end_time}}</p>
			...
			<hr>
			 ...
			 <div class="row">
			   <div class="col-12">
			     ...
			     <div class=" rounded-0 table-responsive">
