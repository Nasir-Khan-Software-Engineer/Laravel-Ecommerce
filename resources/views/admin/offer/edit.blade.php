            ...
            <form action="{{route('admin.offer.update')}}" method="POST" enctype="multipart/form-data">
              <input type="hidden" name="id" value="{{$offer->id}}">
                ...
                <div class="modal-body">
                    ...
                    <input required type="text" class="form-control rounded-0 mb-2 font-pt font-18" name="name" value="{{$offer->name}}">

                    <label for=""><b>Title*</b></label>
                    <input required type="text" class="form-control rounded-0 mb-2 font-pt font-18" name="title" value="{{$offer->title}}">

                    <label for=""><b>Slug*</b></label>
                    <input required type="text" class="form-control rounded-0 mb-2 font-pt font-18" name="slug" value="{{$offer->slug}}">
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-lg-6 mb-2">
                            ...
                            <input value="{{$offer->start_time}}" required type="date" id="start_time" name="start_time" class="form-control rounded-0" >
                        </div>

                        <div class="col-12 col-lg-6 mb-2">
                            <label for="end_time"><b>End Time*</b></label>
                            <input value="{{$offer->end_time}}" required type="date" id="end_time" name="end_time" class="form-control rounded-0" >
                        </div>

                    </div>

                    <label for="details"><b>Details*</b></label>
                    <textarea name="details" id="details" cols="30" rows="4" class="form-control rounded-0 mb-2 font-pt font-18">{{$offer->details}}</textarea>  


                    <label for="description"><b>Short Description(SEO)*</b></label>
                    <textarea  name="description" id="description" cols="30" rows="2" class="form-control rounded-0 mb-2 font-pt font-18">{{$offer->description}}</textarea>

                    <label for=""><b>Tag(SEO)*</b></label>
                    <textarea  name="tag" id="" cols="30" rows="3" class="form-control rounded-0 mb-2 font-pt font-18">{{$offer->tag}}</textarea>
                </div>
