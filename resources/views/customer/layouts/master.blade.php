                        ...
                        <div class="row">
                            ...
                            <div class="col-md-2 col-lg-3 col-6 d-none d-lg-block ">
                                <ul class="menu-extra m-0 text-right">
                                    ...
                                    <li>
                                        <a  href="{{ route('logout') }}" onclick="event.preventDefault();document.getElementById('logout-form').submit();"></i><span class="ti-export"></span></a>
                                        <form id="logout-form" action="{{ route('logout') }}" method="POST" style="display: none;">
                                            @csrf
                                        </form>
                                    </li>
                                    <!-- <li><a href="{{route('logout')}}"><span class="ti-export"></span></a></li> -->
                                    <li class="cart__menu"><span class="ti-shopping-cart"><span class="total_cart_products" ></span></span></li>
                                </ul>
                            </div>
                        </div>
                                ...
                                <div class="category-slider-area pt--10">
                                    <div class="owl-carousel owl-theme popular__product__wrap">
                                        ...
                                        <div class="single-category item">
                                            ...
                                            <img src="{{URL::asset('assets/img/category/')}}/category.jpg" alt="{{$category->name}}">
                                            </a>
                                        </div>
                                        @endif
                                        @endforeach
