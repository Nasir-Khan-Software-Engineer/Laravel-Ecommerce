...
class CreateSettingsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('settings', function (Blueprint $table) {
            ...
            $table->integer('pagination')->default(20);
            ...
            $table->string('product_prefix')->default("Ecom");
            $table->string('order_prefix')->default("Ecom");
            $table->string('invoice_prefix')->default("Ecom");
            $table->text('order_notification_emails')->nullable();
            $table->text('review_notification_emails')->nullable();
